...
public class ListPopupWindow {
    ...
    class C01513 implements OnItemSelectedListener {
        C01513() {
        }
    ...
    class C06581 extends ForwardingListener {
        C06581(View x0) {
            super(x0);
        }
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0107R.attr.dropDownListViewStyle);
    ...
    public ListPopupWindow(Context context) {
        this(context, null, C0107R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(Context context, AttributeSet attrs) {
        this(context, attrs, C0107R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mListItemExpandMaximum = Strategy.TTL_SECONDS_INFINITE;
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0107R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0107R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0107R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            int firstItem = Strategy.TTL_SECONDS_INFINITE;
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C01502();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01513());
            ...
            if (hintView != null) {
                ...
                hintView.measure(MeasureSpec.makeMeasureSpec(this.mDropDownWidth, Target.SIZE_ORIGINAL), POSITION_PROMPT_ABOVE);
