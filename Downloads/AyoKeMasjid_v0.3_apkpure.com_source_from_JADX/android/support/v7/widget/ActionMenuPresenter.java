...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class OverflowMenuButton extends TintImageView implements ActionMenuChildView {
        ...
        class C06551 extends ForwardingListener {
            final /* synthetic */ ActionMenuPresenter val$this$0;

            C06551(View x0, ActionMenuPresenter actionMenuPresenter) {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0107R.attr.actionOverflowButtonStyle);
            this.mTempPts = new float[2];
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new C06551(this, ActionMenuPresenter.this));
        }
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        ...
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu) {
            super(context, subMenu, null, false, C0107R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
            super(context, menu, anchorView, overflowOnly, C0107R.attr.actionOverflowMenuStyle);
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0107R.layout.abc_action_menu_layout, C0107R.layout.abc_action_menu_item_layout);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = this.mContext.getResources().getInteger(C0107R.integer.abc_max_action_buttons);
        }
        if (this.mMenu != null) {
