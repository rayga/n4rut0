...
public class AppCompatButton extends Button implements TintableBackgroundView {
    ...
    public AppCompatButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0107R.attr.buttonStyle);
    }
    ...
    public AppCompatButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, C0107R.styleable.AppCompatTextView, defStyleAttr, 0);
        int ap = a2.getResourceId(C0107R.styleable.AppCompatTextView_android_textAppearance, -1);
        a2.recycle();
        if (ap != -1) {
        ...
        a2 = context.obtainStyledAttributes(attrs, C0107R.styleable.AppCompatTextView, defStyleAttr, 0);
        if (a2.hasValue(C0107R.styleable.AppCompatTextView_textAllCaps)) {
            setAllCaps(a2.getBoolean(C0107R.styleable.AppCompatTextView_textAllCaps, false));
        }
        a2.recycle();
