...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01594 implements OnFocusChangeListener {
        C01594() {
        }
    ...
    class C01605 implements OnLayoutChangeListener {
        C01605() {
        }
    ...
    class C01616 implements OnGlobalLayoutListener {
        C01616() {
        }
    ...
    class C01627 implements OnClickListener {
        C01627() {
        }
    ...
    class C01638 implements OnKeyListener {
        C01638() {
        }
    ...
    class C01649 implements OnEditorActionListener {
        C01649() {
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0107R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0107R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mShowImeRunnable = new C01561();
        this.mUpdateDrawableStateRunnable = new C01572();
        this.mReleaseCursorRunnable = new C01583();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01627();
        this.mTextKeyListener = new C01638();
        this.mOnEditorActionListener = new C01649();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0107R.styleable.SearchView, defStyleAttr, 0);
        this.mTintManager = a.getTintManager();
        LayoutInflater.from(context).inflate(a.getResourceId(C0107R.styleable.SearchView_layout, C0107R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0107R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0107R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0107R.id.search_plate);
        this.mSubmitArea = findViewById(C0107R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0107R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0107R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0107R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0107R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0107R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0107R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0107R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0107R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0107R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0107R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0107R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0107R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0107R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0107R.styleable.SearchView_suggestionRowLayout, C0107R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0107R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01594());
        setIconifiedByDefault(a.getBoolean(C0107R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0107R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0107R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0107R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0107R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0107R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0107R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01605());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01616());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0107R.dimen.abc_search_view_preferred_width);
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0107R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0107R.dimen.abc_dropdownitem_text_padding_left) : 0;
