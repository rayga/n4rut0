...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    public AppCompatPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0107R.styleable.PopupWindow, defStyleAttr, 0);
        this.mOverlapAnchor = a.getBoolean(C0107R.styleable.PopupWindow_overlapAnchor, false);
        setBackgroundDrawable(a.getDrawable(C0107R.styleable.PopupWindow_android_popupBackground));
        a.recycle();
