...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C08901 extends ViewPropertyAnimatorListenerAdapter {
        C08901() {
        }
    ...
    class C08912 extends ViewPropertyAnimatorListenerAdapter {
        C08912() {
        }
    ...
    static {
        ATTRS = new int[]{C0107R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C08901();
        this.mBottomAnimatorListener = new C08912();
        this.mRemoveActionBarHideOffset = new C01133();
        this.mAddActionBarHideOffset = new C01144();
        init(context);
    ...
    public void onWindowSystemUiVisibilityChanged(int visible) {
        ...
        if ((diff & Barcode.QR_CODE) != 0 && this.mActionBarVisibilityCallback != null) {
            ViewCompat.requestApplyInsets(this);
        }
    }
    ...
    protected boolean fitSystemWindows(Rect insets) {
        pullChildren();
        if ((ViewCompat.getWindowSystemUiVisibility(this) & Barcode.QR_CODE) != 0) {
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean stable = (ViewCompat.getWindowSystemUiVisibility(this) & Barcode.QR_CODE) != 0;
        if (stable) {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0107R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0107R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0107R.id.action_bar));
            this.mActionBarBottom = (ActionBarContainer) findViewById(C0107R.id.split_action_bar);
        }
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, Target.SIZE_ORIGINAL, Strategy.TTL_SECONDS_INFINITE);
