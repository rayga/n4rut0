...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0107R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0107R.styleable.ActionBar, C0107R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0107R.styleable.ActionBar_height, 0));
        a.recycle();
    ...
    public void animateToVisibility(int visibility) {
        ...
        if (visibility == 0) {
            ...
            anim = ViewCompat.animate(this).alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            ...
            ViewPropertyAnimatorCompat splitAnim = ViewCompat.animate(this.mMenuView).alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
