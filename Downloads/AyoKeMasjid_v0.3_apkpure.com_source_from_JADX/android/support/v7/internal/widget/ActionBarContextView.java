...
public class ActionBarContextView extends AbsActionBarView implements ViewPropertyAnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0107R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0107R.styleable.ActionMode, defStyle, ANIMATE_IDLE);
        setBackgroundDrawable(a.getDrawable(C0107R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0107R.styleable.ActionMode_titleTextStyle, ANIMATE_IDLE);
        this.mSubtitleStyleRes = a.getResourceId(C0107R.styleable.ActionMode_subtitleTextStyle, ANIMATE_IDLE);
        this.mContentHeight = a.getLayoutDimension(C0107R.styleable.ActionMode_height, (int) ANIMATE_IDLE);
        this.mSplitBackground = a.getDrawable(C0107R.styleable.ActionMode_backgroundSplit);
        this.mCloseItemLayout = a.getResourceId(C0107R.styleable.ActionMode_closeItemLayout, C0107R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
        ...
        if (this.mSplitActionBar != split) {
            if (this.mActionMenuPresenter != null) {
                ...
                if (split) {
                    ...
                    this.mActionMenuPresenter.setItemLimit(Strategy.TTL_SECONDS_INFINITE);
    ...
    private void initTitle() {
        ...
        int i2 = 8;
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0107R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0107R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0107R.id.action_bar_subtitle);
    ...
    public void initForMode(ActionMode mode) {
        ...
        this.mClose.findViewById(C0107R.id.action_mode_close_button).setOnClickListener(new C01121(mode));
        ...
        if (this.mMenuView != null) {
            ...
            if (count > 0) {
                ...
                while (i >= 0) {
                    ...
                    ViewPropertyAnimatorCompat a = ViewCompat.animate(child).scaleY(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                    a.setDuration(300);
                    set.play(a);
                    i--;
                    j += ANIMATE_IN;
    ...
    private ViewPropertyAnimatorCompatSet makeOutAnimation() {
        ...
        if (this.mMenuView != null && this.mMenuView.getChildCount() > 0) {
            for (int i = ANIMATE_IDLE; i < 0; i += ANIMATE_IN) {
                View child = this.mMenuView.getChildAt(i);
                ViewCompat.setScaleY(child, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
