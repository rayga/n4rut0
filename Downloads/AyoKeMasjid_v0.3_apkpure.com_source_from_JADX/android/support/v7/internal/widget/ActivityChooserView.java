...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01161 extends DataSetObserver {
        C01161() {
        }
    ...
    class C01172 implements OnGlobalLayoutListener {
        C01172() {
        }
    ...
    class C01184 extends DataSetObserver {
        C01184() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case ITEM_VIEW_TYPE_ACTIVITY /*0*/:
                    if (convertView == null || convertView.getId() != C0107R.id.list_item) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0107R.layout.abc_activity_chooser_view_list_item, parent, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    ((ImageView) convertView.findViewById(C0107R.id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0107R.id.title)).setText(activity.loadLabel(packageManager));
                ...
                case ITEM_VIEW_TYPE_FOOTER /*1*/:
                    if (convertView == null || convertView.getId() != ITEM_VIEW_TYPE_FOOTER) {
                        ...
                        ((TextView) convertView.findViewById(C0107R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0107R.string.abc_activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            switch (((ActivityChooserViewAdapter) parent.getAdapter()).getItemViewType(position)) {
                ...
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ActivityChooserView.this.showPopupUnchecked(Strategy.TTL_SECONDS_INFINITE);
                default:
                    throw new IllegalArgumentException();
            }
        }
    ...
    class C06483 extends ForwardingListener {
        C06483(View x0) {
            super(x0);
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetOberver = new C01161();
        this.mOnGlobalLayoutListener = new C01172();
        this.mInitialActivityCount = 4;
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0107R.styleable.ActivityChooserView, defStyle, 0);
        this.mInitialActivityCount = attributesArray.getInt(C0107R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0107R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributesArray.recycle();
        LayoutInflater.from(getContext()).inflate(C0107R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0107R.id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0107R.id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0107R.id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0107R.id.expand_activities_button);
        expandButton.setOnClickListener(this.mCallbacks);
        expandButton.setOnTouchListener(new C06483(expandButton));
        this.mExpandActivityOverflowButton = expandButton;
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(C0107R.id.image);
        ...
        this.mAdapter.registerDataSetObserver(new C01184());
        Resources resources = context.getResources();
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0107R.dimen.abc_config_prefDialogWidth));
    }
    ...
    private void showPopupUnchecked(int maxActivityCount) {
        ...
        if (maxActivityCount == Strategy.TTL_SECONDS_INFINITE || activityCount <= maxActivityCount + maxActivityCountOffset) {
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(getContext().getString(C0107R.string.abc_activitychooserview_choose_application));
        }
    }
