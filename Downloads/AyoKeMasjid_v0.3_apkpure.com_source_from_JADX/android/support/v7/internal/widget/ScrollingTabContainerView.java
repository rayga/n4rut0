...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemClickListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean forList) {
            super(context, null, C0107R.attr.actionBarTabStyle);
            this.BG_ATTRS = new int[]{16842964};
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0107R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), null, C0107R.attr.actionBarTabTextStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0107R.attr.actionBarTabBarStyle);
    ...
    private SpinnerCompat createSpinner() {
        SpinnerCompat spinner = new SpinnerCompat(getContext(), null, C0107R.attr.actionDropDownStyle);
    ...
    public void animateToTab(int position) {
        ...
        this.mTabSelector = new C01211(tabView);
