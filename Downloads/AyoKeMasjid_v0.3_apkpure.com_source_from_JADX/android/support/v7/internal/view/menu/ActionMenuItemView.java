...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, OnLongClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mAllowTextWithIcon = res.getBoolean(C0107R.bool.abc_config_allowActionMenuItemTextWithIcon);
        TypedArray a = context.obtainStyledAttributes(attrs, C0107R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0107R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        this.mAllowTextWithIcon = getContext().getResources().getBoolean(C0107R.bool.abc_config_allowActionMenuItemTextWithIcon);
