...
public class MenuPopupHelper implements OnItemClickListener, OnKeyListener, OnGlobalLayoutListener, OnDismissListener, MenuPresenter {
    ...
    static {
        ITEM_LAYOUT = C0107R.layout.abc_popup_menu_item_layout;
    }

    public MenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, null, false, C0107R.attr.popupMenuStyle);
    }

    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView) {
        this(context, menu, anchorView, false, C0107R.attr.popupMenuStyle);
    }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly, int popupStyleAttr, int popupStyleRes) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0107R.dimen.abc_config_prefDialogWidth));
