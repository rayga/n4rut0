...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C06463 implements ViewPropertyAnimatorUpdateListener {
        C06463() {
        }
    ...
    class C08871 extends ViewPropertyAnimatorListenerAdapter {
        C08871() {
        }
    ...
    class C08882 extends ViewPropertyAnimatorListenerAdapter {
        C08882() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C08871();
        this.mShowListener = new C08882();
        this.mUpdateListener = new C06463();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0107R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0107R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0107R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0107R.id.action_bar_container);
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0107R.id.split_action_bar);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0107R.styleable.ActionBar, C0107R.attr.actionBarStyle, CONTEXT_DISPLAY_NORMAL);
        if (a.getBoolean(C0107R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0107R.styleable.ActionBar_elevation, CONTEXT_DISPLAY_NORMAL);
        if (elevation != 0) {
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            if (this.mSplitView != null && this.mContextDisplayMode == CONTEXT_DISPLAY_SPLIT) {
                ViewCompat.setAlpha(this.mSplitView, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0107R.attr.actionBarWidgetTheme, outValue, true);
