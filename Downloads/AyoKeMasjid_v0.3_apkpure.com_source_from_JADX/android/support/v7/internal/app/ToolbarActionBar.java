...
public class ToolbarActionBar extends ActionBar {
    ...
    class C06452 implements OnMenuItemClickListener {
        C06452() {
        }
    ...
    public ToolbarActionBar(Toolbar toolbar, CharSequence title, Callback callback) {
        ...
        this.mMenuInvalidator = new C01091();
        this.mMenuClicker = new C06452();
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0107R.layout.abc_list_menu_item_layout);
