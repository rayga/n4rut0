...
public class RemotePlaybackClient {
    ...
    class C06531 extends ControlRequestCallback {
        final /* synthetic */ ItemActionCallback val$callback;
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ String val$itemId;
        final /* synthetic */ String val$sessionId;

        C06531(String str, String str2, Intent intent, ItemActionCallback itemActionCallback) {
    ...
    class C06542 extends ControlRequestCallback {
        final /* synthetic */ SessionActionCallback val$callback;
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ String val$sessionId;

        C06542(String str, Intent intent, SessionActionCallback sessionActionCallback) {
            this.val$sessionId = str;
            this.val$intent = intent;
    ...
    private void performItemAction(Intent intent, String sessionId, String itemId, Bundle extras, ItemActionCallback callback) {
        ...
        logRequest(intent);
        this.mRoute.sendControlRequest(intent, new C06531(sessionId, itemId, intent, callback));
    }
    ...
    private void performSessionAction(Intent intent, String sessionId, Bundle extras, SessionActionCallback callback) {
        ...
        logRequest(intent);
        this.mRoute.sendControlRequest(intent, new C06542(sessionId, intent, callback));
    }
