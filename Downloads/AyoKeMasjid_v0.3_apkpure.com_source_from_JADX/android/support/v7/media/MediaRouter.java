...
public final class MediaRouter {
    ...
    private static final class GlobalMediaRouter implements SyncCallback, android.support.v7.media.RegisteredMediaRouteProviderWatcher.Callback {
        ...
        private final class MediaSessionRecord {
            ...
            class C06521 extends VolumeProviderCompat {
                ...
                C06521(int x0, int x1, int x2) {
                    super(x0, x1, x2);
                }

                public void onSetVolumeTo(int volume) {
                    GlobalMediaRouter.this.mCallbackHandler.post(new C01341(volume));
                }

                public void onAdjustVolume(int direction) {
                    GlobalMediaRouter.this.mCallbackHandler.post(new C01352(direction));
                }
            }
            ...
            public void configureVolume(int controlType, int max, int current) {
                ...
                this.mVpCompat = new C06521(controlType, max, current);
        ...
        class C06511 implements OnActiveChangeListener {
            C06511() {
            }
        ...
        GlobalMediaRouter(Context applicationContext) {
            ...
            this.mSessionActiveListener = new C06511();
