...
public abstract class MediaRouteProviderService extends Service {
    ...
    class C06501 extends ControlRequestCallback {
        ...
        C06501(ClientRecord clientRecord, int i, Intent intent, Messenger messenger, int i2) {
    ...
    private boolean onRouteControlRequest(Messenger messenger, int requestId, int controllerId, Intent intent) {
        ...
        if (client != null) {
            ...
            if (controller != null) {
                ...
                if (requestId != 0) {
                    callback = new C06501(client, controllerId, intent, messenger, requestId);
                }
