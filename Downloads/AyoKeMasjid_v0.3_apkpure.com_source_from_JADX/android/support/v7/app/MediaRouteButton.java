...
public class MediaRouteButton extends View {
    ...
    public MediaRouteButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0142R.attr.mediaRouteButtonStyle);
    }
    ...
    public MediaRouteButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0142R.styleable.MediaRouteButton, defStyleAttr, 0);
        setRemoteIndicatorDrawable(a.getDrawable(C0142R.styleable.MediaRouteButton_externalRouteEnabledDrawable));
        this.mMinWidth = a.getDimensionPixelSize(C0142R.styleable.MediaRouteButton_android_minWidth, 0);
        this.mMinHeight = a.getDimensionPixelSize(C0142R.styleable.MediaRouteButton_android_minHeight, 0);
        a.recycle();
        setClickable(true);
