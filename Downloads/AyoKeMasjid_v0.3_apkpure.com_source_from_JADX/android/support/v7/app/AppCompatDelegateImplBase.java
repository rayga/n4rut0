...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), null, new int[]{C0107R.attr.homeAsUpIndicator});
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (a.hasValue(C0107R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0107R.styleable.Theme_windowActionBar, false)) {
                this.mHasActionBar = true;
            }
            if (a.getBoolean(C0107R.styleable.Theme_windowActionBarOverlay, false)) {
                this.mOverlayActionBar = true;
            }
            if (a.getBoolean(C0107R.styleable.Theme_windowActionModeOverlay, false)) {
                this.mOverlayActionMode = true;
            }
            this.mIsFloating = a.getBoolean(C0107R.styleable.Theme_android_windowIsFloating, false);
            this.mWindowNoTitle = a.getBoolean(C0107R.styleable.Theme_windowNoTitle, false);
            a.recycle();
            return;
        }
        a.recycle();
