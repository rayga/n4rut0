...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    public void syncState() {
        if (this.mDrawerLayout.isDrawerOpen((int) MediaRouterJellybean.ALL_ROUTE_TYPES)) {
            this.mSlider.setPosition(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
        } else {
            this.mSlider.setPosition(0.0f);
        }
        if (this.mDrawerIndicatorEnabled) {
            setActionBarUpIndicator((Drawable) this.mSlider, this.mDrawerLayout.isDrawerOpen((int) MediaRouterJellybean.ALL_ROUTE_TYPES) ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
        }
    }
    ...
    private void toggle() {
        if (this.mDrawerLayout.isDrawerVisible((int) MediaRouterJellybean.ALL_ROUTE_TYPES)) {
            this.mDrawerLayout.closeDrawer((int) MediaRouterJellybean.ALL_ROUTE_TYPES);
        } else {
            this.mDrawerLayout.openDrawer((int) MediaRouterJellybean.ALL_ROUTE_TYPES);
        }
    }
