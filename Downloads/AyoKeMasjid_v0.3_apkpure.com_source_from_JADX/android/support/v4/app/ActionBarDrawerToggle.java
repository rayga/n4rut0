...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    public void syncState() {
        ...
        if (this.mDrawerIndicatorEnabled) {
            setActionBarUpIndicator(this.mSlider, this.mDrawerLayout.isDrawerOpen((int) MediaRouterJellybean.ALL_ROUTE_TYPES) ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
        }
    }
