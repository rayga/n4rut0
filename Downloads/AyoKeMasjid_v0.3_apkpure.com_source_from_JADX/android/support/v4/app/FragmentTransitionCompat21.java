...
class FragmentTransitionCompat21 {
    ...
    static class C00091 extends EpicenterCallback {
    ...
    static class C00102 implements OnPreDrawListener {
        ...
        C00102(View view, ViewRetriever viewRetriever, Map map, Map map2, Transition transition, ArrayList arrayList, View view2) {
    ...
    static class C00113 extends EpicenterCallback {
        private Rect mEpicenter;
        final /* synthetic */ EpicenterView val$epicenterView;

        C00113(EpicenterView epicenterView) {
    ...
    static class C00124 implements OnPreDrawListener {
        final /* synthetic */ Transition val$enterTransition;
        final /* synthetic */ ArrayList val$enteringViews;
        ...
        C00124(View view, Transition transition, View view2, ArrayList arrayList, Transition transition2, ArrayList arrayList2, Transition transition3, ArrayList arrayList3, Map map, ArrayList arrayList4, Transition transition4) {
    ...
    public static void setEpicenter(Object transitionObject, View view) {
        ((Transition) transitionObject).setEpicenterCallback(new C00091(getBoundsOnScreen(view)));
    }
    ...
    public static void addTransitionTargets(Object enterTransitionObject, Object sharedElementTransitionObject, View container, ViewRetriever inFragment, View nonExistentView, EpicenterView epicenterView, Map<String, String> nameOverrides, ArrayList<View> enteringViews, Map<String, View> renamedViews, ArrayList<View> sharedElementTargets) {
        if (enterTransitionObject != null || sharedElementTransitionObject != null) {
            ...
            if (inFragment != null) {
                container.getViewTreeObserver().addOnPreDrawListener(new C00102(container, inFragment, nameOverrides, renamedViews, enterTransition, enteringViews, nonExistentView));
            }
    ...
    private static void setSharedElementEpicenter(Transition transition, EpicenterView epicenterView) {
        if (transition != null) {
            transition.setEpicenterCallback(new C00113(epicenterView));
        }
    }
    ...
    public static void cleanupTransitions(View sceneRoot, View nonExistentView, Object enterTransitionObject, ArrayList<View> enteringViews, Object exitTransitionObject, ArrayList<View> exitingViews, Object sharedElementTransitionObject, ArrayList<View> sharedElementTargets, Object overallTransitionObject, ArrayList<View> hiddenViews, Map<String, View> renamedViews) {
        ...
        if (overallTransition != null) {
            sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00124(sceneRoot, enterTransition, nonExistentView, enteringViews, exitTransition, exitingViews, sharedElementTransition, sharedElementTargets, renamedViews, hiddenViews, overallTransition));
        }
    }
