    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case ANIM_STYLE_OPEN_ENTER /*1*/:
                return makeOpenCloseAnimation(this.mActivity, 1.125f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case ANIM_STYLE_OPEN_EXIT /*2*/:
                return makeOpenCloseAnimation(this.mActivity, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.975f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f);
            case ANIM_STYLE_CLOSE_ENTER /*3*/:
                return makeOpenCloseAnimation(this.mActivity, 0.975f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case ANIM_STYLE_CLOSE_EXIT /*4*/:
                return makeOpenCloseAnimation(this.mActivity, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 1.075f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f);
            case ANIM_STYLE_FADE_ENTER /*5*/:
                return makeFadeAnimation(this.mActivity, 0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case ANIM_STYLE_FADE_EXIT /*6*/:
                return makeFadeAnimation(this.mActivity, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f);
            default:
