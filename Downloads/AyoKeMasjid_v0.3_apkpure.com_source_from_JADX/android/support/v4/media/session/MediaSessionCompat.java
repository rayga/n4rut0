...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00321 implements Creator<QueueItem> {
            C00321() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00331 implements Creator<ResultReceiverWrapper> {
            C00331() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C00341 implements Creator<Token> {
            C00341() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class C06281 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C06281() {
            }
        ...
        class C06292 implements android.support.v4.media.session.MediaSessionCompatApi14.Callback {
            final /* synthetic */ Callback val$callback;

            C06292(Callback callback) {
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbr) {
            ...
            this.mVolumeCallback = new C06281();
        ...
        public void setCallback(Callback callback, Handler handler) {
            if (callback != this.mCallback) {
                if (callback == null || VERSION.SDK_INT < 18) {
                    ...
                    android.support.v4.media.session.MediaSessionCompatApi14.Callback cb14 = new C06292(callback);
                    if (VERSION.SDK_INT >= 18) {
        ...
        private PlaybackStateCompat getStateWithUpdatedPosition() {
            ...
            synchronized (this.mLock) {
                ...
                if (this.mMetadata != null && this.mMetadata.containsKey(MediaItemMetadata.KEY_DURATION)) {
                    duration = this.mMetadata.getLong(MediaItemMetadata.KEY_DURATION);
                }
            }
