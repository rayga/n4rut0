...
class VolumeProviderCompatApi21 {
    ...
    static class C00291 extends VolumeProvider {
        final /* synthetic */ Delegate val$delegate;

        C00291(int x0, int x1, int x2, Delegate delegate) {
    ...
    public static Object createVolumeProvider(int volumeControl, int maxVolume, int currentVolume, Delegate delegate) {
        return new C00291(volumeControl, maxVolume, currentVolume, delegate);
    }
