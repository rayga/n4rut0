...
public class TransportMediator extends TransportController {
    ...
    class C00242 implements Callback {
        C00242() {
        }
    ...
    class C06261 implements TransportMediatorCallback {
        C06261() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C06261();
        this.mKeyEventCallback = new C00242();
