...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00251 implements OnWindowAttachListener {
        C00251() {
        }
    ...
    class C00262 implements OnWindowFocusChangeListener {
        C00262() {
        }
    ...
    class C00273 extends BroadcastReceiver {
        C00273() {
        }
    ...
    class C00284 implements OnAudioFocusChangeListener {
        C00284() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00251();
        this.mWindowFocusListener = new C00262();
        this.mMediaButtonReceiver = new C00273();
        this.mAudioFocusChangeListener = new C00284();
        this.mPlayState = 0;
