...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = MeasureSpec.makeMeasureSpec((int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * 0.8f), Target.SIZE_ORIGINAL);
        int childHeightSpec = MeasureSpec.makeMeasureSpec(childHeight, Target.SIZE_ORIGINAL);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        childHeight -= padding;
        int childWidthSpec = MeasureSpec.makeMeasureSpec((int) (((float) widthSize) * 0.8f), Target.SIZE_ORIGINAL);
        int childHeightSpec = MeasureSpec.makeMeasureSpec(childHeight, Target.SIZE_ORIGINAL);
        this.mPrevText.measure(childWidthSpec, childHeightSpec);
        this.mCurrText.measure(childWidthSpec, childHeightSpec);
        this.mNextText.measure(childWidthSpec, childHeightSpec);
