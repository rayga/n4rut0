...
public class ViewPager extends ViewGroup {
    ...
    static class C00561 implements Comparator<ItemInfo> {
        C00561() {
        }
    ...
    static class C00572 implements Interpolator {
        C00572() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C06361 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C06361() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C06361());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00561();
        sInterpolator = new C00572();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00583();
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int widthMode = Target.SIZE_ORIGINAL;
                    int heightMode = Target.SIZE_ORIGINAL;
