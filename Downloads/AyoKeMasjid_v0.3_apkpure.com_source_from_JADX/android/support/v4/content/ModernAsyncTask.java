...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00193 extends FutureTask<Result> {
        C00193(Callable x0) {
            super(x0);
        }
    ...
    class C06252 extends WorkerRunnable<Params, Result> {
        C06252() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C06252();
        this.mFuture = new C00193(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00204.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
