...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C00741 extends Animation {
    ...
    class C00752 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    class C00763 implements Callback {
        C00763() {
        }
    ...
    private void applyFinishTranslation(float interpolatedTime, Ring ring) {
        ...
        float targetRotation = (float) (Math.floor((double) (ring.getStartingRotation() / MAX_PROGRESS_ARC)) + Utils.AGGRESSIVE_ROUND_SEC);
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C00741(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C00752(ring));
