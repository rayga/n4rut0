...
public class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C06401 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListenerCompat val$listener;

            C06401(OnQueryTextListenerCompat onQueryTextListenerCompat) {
        ...
        class C06412 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListenerCompat val$listener;

            C06412(OnCloseListenerCompat onCloseListenerCompat) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListenerCompat listener) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C06401(listener));
        }
        ...
        public Object newOnCloseListener(OnCloseListenerCompat listener) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C06412(listener));
        }
