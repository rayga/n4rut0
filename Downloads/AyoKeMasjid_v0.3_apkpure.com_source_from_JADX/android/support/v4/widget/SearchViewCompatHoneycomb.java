...
class SearchViewCompatHoneycomb {
    ...
    static class C00781 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00781(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00792 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00792(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
