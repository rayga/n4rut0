...
public class ColorUtils {
    ...
    public static int HSLToColor(float[] hsl) {
        ...
        float m = l - (0.5f * c);
        float x = c * (DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - Math.abs(((h / BitmapDescriptorFactory.HUE_YELLOW) % ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        int r = 0;
        int g = 0;
        int b = 0;
        switch (((int) h) / 60) {
