...
class TextToSpeechICSMR1 {
    ...
    static class C00451 extends UtteranceProgressListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00451(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
    ...
    static class C00462 implements OnUtteranceCompletedListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00462(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
            this.val$listener = utteranceProgressListenerICSMR1;
        }
    ...
    static void setUtteranceProgressListener(TextToSpeech tts, UtteranceProgressListenerICSMR1 listener) {
        if (VERSION.SDK_INT >= 15) {
            tts.setOnUtteranceProgressListener(new C00451(listener));
        } else {
            tts.setOnUtteranceCompletedListener(new C00462(listener));
        }
    }
}
