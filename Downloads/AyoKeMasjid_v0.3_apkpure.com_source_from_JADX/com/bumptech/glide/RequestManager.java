...
public class RequestManager implements LifecycleListener {
    ...
    RequestManager(Context context, Lifecycle lifecycle, RequestTracker requestTracker, ConnectivityMonitorFactory factory) {
        ...
        if (Util.isOnBackgroundThread()) {
            new Handler(Looper.getMainLooper()).post(new C01821(lifecycle));
        } else {
