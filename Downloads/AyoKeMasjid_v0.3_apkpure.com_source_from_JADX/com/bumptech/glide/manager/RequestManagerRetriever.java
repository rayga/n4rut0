    ...
    RequestManager fragmentGet(Context context, FragmentManager fm) {
        ...
        if (current == null) {
            ...
            if (current == null) {
                ...
                this.handler.obtainMessage(ID_REMOVE_FRAGMENT_MANAGER, fm).sendToTarget();
            }
        }
    ...
    RequestManager supportFragmentGet(Context context, android.support.v4.app.FragmentManager fm) {
        ...
        if (current == null) {
            ...
            if (current == null) {
                ...
                this.handler.obtainMessage(ID_REMOVE_SUPPORT_FRAGMENT_MANAGER, fm).sendToTarget();
            }
        }
        RequestManager requestManager = current.getRequestManager();
        if (requestManager != null) {
