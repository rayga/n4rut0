...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C06701 implements PreloadModelProvider<T> {
        C06701() {
        }
    ...
    class C06712 implements PreloadSizeProvider<T> {
        C06712() {
        }
    ...
    public ListPreloader(int maxPreload) {
        ...
        this.preloadModelProvider = new C06701();
        this.preloadDimensionProvider = new C06712();
