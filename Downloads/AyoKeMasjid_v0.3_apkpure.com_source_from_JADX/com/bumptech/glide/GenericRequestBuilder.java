...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    class C01801 implements Runnable {
        ...
        C01801(RequestFutureTarget requestFutureTarget) {
    ...
    GenericRequestBuilder(Context context, Class<ModelType> modelClass, LoadProvider<ModelType, DataType, ResourceType, TranscodeType> loadProvider, Class<TranscodeType> transcodeClass, Glide glide, RequestTracker requestTracker, Lifecycle lifecycle) {
        ...
        this.sizeMultiplier = Float.valueOf(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
        this.priority = null;
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> thumbnail(float sizeMultiplier) {
        if (sizeMultiplier < 0.0f || sizeMultiplier > DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) {
    ...
    public Target<TranscodeType> into(ImageView view) {
        ...
        if (!(this.isTransformationSet || view.getScaleType() == null)) {
            switch (C01812.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
    ...
    public FutureTarget<TranscodeType> into(int width, int height) {
        ...
        this.glide.getMainHandler().post(new C01801(target));
        return target;
    }
    ...
    private Request buildRequestRecursive(Target<TranscodeType> target, ThumbnailRequestCoordinator parentCoordinator) {
        ...
        if (this.thumbnailRequestBuilder != null) {
            ...
            coordinator.setRequests(fullRequest, this.thumbnailRequestBuilder.buildRequestRecursive(target, coordinator));
            return coordinator;
