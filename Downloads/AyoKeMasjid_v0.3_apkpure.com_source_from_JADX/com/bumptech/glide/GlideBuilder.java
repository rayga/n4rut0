...
public class GlideBuilder {
    ...
    class C06691 implements Factory {
        final /* synthetic */ DiskCache val$diskCache;

        C06691(DiskCache diskCache) {
    ...
    public GlideBuilder setDiskCache(DiskCache diskCache) {
        return setDiskCache(new C06691(diskCache));
    }
    ...
    Glide createGlide() {
        ...
        if (this.diskCacheFactory == null) {
            this.diskCacheFactory = new InternalCacheDiskCacheFactory(this.context, 262144000);
        }
        if (this.engine == null) {
