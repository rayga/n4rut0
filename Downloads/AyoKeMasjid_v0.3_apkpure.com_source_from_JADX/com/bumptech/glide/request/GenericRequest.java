...
public final class GenericRequest<A, T, Z, R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void onResourceReady(Resource<?> resource) {
        ...
        if (received == null || !this.transcodeClass.isAssignableFrom(received.getClass())) {
            ...
            onException(new Exception("Expected to receive an object of " + this.transcodeClass + " but instead got " + (received != null ? received.getClass() : BuildConfig.FLAVOR) + "{" + received + "}" + " inside Resource{" + resource + "}." + (received != null ? BuildConfig.FLAVOR : " To indicate failure return a null Resource object, rather than a Resource object containing null data.")));
