    ...
    static void initializeMatrixForRotation(int exifOrientation, Matrix matrix) {
        switch (exifOrientation) {
            case CompletionEvent.STATUS_CONFLICT /*2*/:
                matrix.setScale(GroundOverlayOptions.NO_DIMENSION, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case CompletionEvent.STATUS_CANCELED /*3*/:
                matrix.setRotate(BitmapDescriptorFactory.HUE_CYAN);
            case Barcode.PHONE /*4*/:
                matrix.setRotate(BitmapDescriptorFactory.HUE_CYAN);
                matrix.postScale(GroundOverlayOptions.NO_DIMENSION, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case Barcode.PRODUCT /*5*/:
