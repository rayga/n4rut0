...
class EngineKey implements Key {
    ...
    public String toString() {
        if (this.stringKey == null) {
            String id;
            StringBuilder append = new StringBuilder().append(this.id).append(this.signature).append(this.width).append(this.height);
            if (this.cacheDecoder != null) {
            ...
            this.stringKey = append.append(id).toString();
        }
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) throws UnsupportedEncodingException {
        ...
        messageDigest.update((this.cacheDecoder != null ? this.cacheDecoder.getId() : BuildConfig.FLAVOR).getBytes(Key.STRING_CHARSET_NAME));
        messageDigest.update((this.decoder != null ? this.decoder.getId() : BuildConfig.FLAVOR).getBytes(Key.STRING_CHARSET_NAME));
        messageDigest.update((this.transformation != null ? this.transformation.getId() : BuildConfig.FLAVOR).getBytes(Key.STRING_CHARSET_NAME));
        messageDigest.update((this.encoder != null ? this.encoder.getId() : BuildConfig.FLAVOR).getBytes(Key.STRING_CHARSET_NAME));
        messageDigest.update((this.sourceEncoder != null ? this.sourceEncoder.getId() : BuildConfig.FLAVOR).getBytes(Key.STRING_CHARSET_NAME));
    }
}
