...
public class MemorySizeCalculator {
    ...
    private static int getMaxSize(ActivityManager activityManager) {
        return Math.round((isLowMemoryDevice(activityManager) ? LOW_MEMORY_MAX_SIZE_MULTIPLIER : MAX_SIZE_MULTIPLIER) * ((float) ((activityManager.getMemoryClass() * Barcode.UPC_E) * Barcode.UPC_E)));
    }
