...
public class ImageLoader {
    ...
    class C01784 implements Runnable {
        C01784() {
        }
    ...
    class C06672 implements Listener<Bitmap> {
    ...
    class C06683 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new C09011(errorImageResId, view, defaultImageResId);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, String cacheKey) {
        return new ImageRequest(requestUrl, new C06672(cacheKey), maxWidth, maxHeight, scaleType, Config.RGB_565, new C06683(cacheKey));
    }
