...
public class zzo implements SettingsApi {
    ...
    class C12091 extends zza<LocationSettingsResult> {
        final /* synthetic */ LocationSettingsRequest zzaDe;
        final /* synthetic */ String zzaDf;
        final /* synthetic */ zzo zzaDg;

        C12091(zzo com_google_android_gms_location_internal_zzo, GoogleApiClient googleApiClient, LocationSettingsRequest locationSettingsRequest, String str) {
    ...
    public PendingResult<LocationSettingsResult> zza(GoogleApiClient googleApiClient, LocationSettingsRequest locationSettingsRequest, String str) {
        return googleApiClient.zza(new C12091(this, googleApiClient, locationSettingsRequest, str));
    }
}
