...
public class zziq extends WebViewClient {
    ...
    class C03941 implements Runnable {
        ...
        C03941(zziq com_google_android_gms_internal_zziq) {
    ...
    static {
        zzIU = new String[]{"UNKNOWN", "HOST_LOOKUP", "UNSUPPORTED_AUTH_SCHEME", "AUTHENTICATION", "PROXY_AUTHENTICATION", "CONNECT", "IO", InstanceID.ERROR_TIMEOUT, "REDIRECT_LOOP", "UNSUPPORTED_SCHEME", "FAILED_SSL_HANDSHAKE", "BAD_URL", "FILE", "FILE_NOT_FOUND", "TOO_MANY_REQUESTS"};
    ...
    public final void onLoadResource(WebView webView, String url) {
        com.google.android.gms.ads.internal.util.client.zzb.m14v("Loading resource: " + url);
    ...
    public final void onPageFinished(WebView webView, String url) {
        synchronized (this.zzpc) {
            if (this.zzJe && "about:blank".equals(url)) {
                com.google.android.gms.ads.internal.util.client.zzb.m14v("Blank page loaded, 1...");
                this.zzoL.zzgX();
                return;
            }
            this.zzJf = true;
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String url) {
        com.google.android.gms.ads.internal.util.client.zzb.m14v("AdWebView shouldOverrideUrlLoading: " + url);
        Uri parse = Uri.parse(url);
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            zzh(parse);
    ...
    public final void zzeA() {
        synchronized (this.zzpc) {
            this.zzIZ = false;
            this.zzqL = true;
            zzhu.runOnUiThread(new C03941(this));
        }
    }
    ...
    public void zzh(Uri uri) {
        ...
        if (list != null) {
            ...
            if (com.google.android.gms.ads.internal.util.client.zzb.zzM(2)) {
                com.google.android.gms.ads.internal.util.client.zzb.m14v("Received GMSG: " + path);
                for (String path2 : zze.keySet()) {
                    com.google.android.gms.ads.internal.util.client.zzb.m14v("  " + path2 + ": " + ((String) zze.get(path2)));
                }
            }
            for (zzdg zza : list) {
        ...
        com.google.android.gms.ads.internal.util.client.zzb.m14v("No GMSG handler found for GMSG: " + uri);
    }
    ...
    public void zzhd() {
        synchronized (this.zzpc) {
            com.google.android.gms.ads.internal.util.client.zzb.m14v("Loading blank page in WebView, 2...");
            this.zzJe = true;
