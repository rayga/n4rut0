...
public class zzqg {
    ...
    class C08111 implements ResultCallback<ContainerHolder> {
        final /* synthetic */ zzqg zzaTs;

        C08111(zzqg com_google_android_gms_internal_zzqg) {
    ...
    public void start() throws IllegalStateException {
        synchronized (this) {
            if (this.mStarted) {
                ...
                this.mStarted = true;
                this.zzaTr.zzc(this.zzpo.zzBj(), -1, "admob").setResultCallback(new C08111(this));
            }
        }
    }
