...
public interface zzoy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzoy {

        private static class zza implements zzoy {
        ...
        public static zzoy zzdb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzoy)) ? new zza(iBinder) : (zzoy) queryLocalInterface;
        }
