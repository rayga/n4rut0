...
class zzru implements Cloneable {
    ...
    void zza(zzrz com_google_android_gms_internal_zzrz) {
        this.zzbcj.add(com_google_android_gms_internal_zzrz);
    }

    <T> T zzb(zzrs<?, T> com_google_android_gms_internal_zzrs___T) {
        if (this.zzbci == null) {
            this.zzbch = com_google_android_gms_internal_zzrs___T;
            this.zzbci = com_google_android_gms_internal_zzrs___T.zzx(this.zzbcj);
            this.zzbcj = null;
        } else if (this.zzbch != com_google_android_gms_internal_zzrs___T) {
