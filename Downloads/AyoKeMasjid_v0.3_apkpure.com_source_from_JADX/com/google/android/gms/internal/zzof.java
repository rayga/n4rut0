...
public final class zzof {
    ...
    class C04061 implements Runnable {
        ...
        C04061(zzof com_google_android_gms_internal_zzof, zzob com_google_android_gms_internal_zzob) {
    ...
    private class zza extends ThreadPoolExecutor {
        ...
        class C04071 extends FutureTask<T> {
            final /* synthetic */ zza zzaIk;

            C04071(zza com_google_android_gms_internal_zzof_zza, Runnable runnable, Object obj) {
        ...
        protected <T> RunnableFuture<T> newTaskFor(Runnable runnable, T value) {
            return new C04071(this, runnable, value);
        }
    }
    ...
    void zze(zzob com_google_android_gms_internal_zzob) {
        if (com_google_android_gms_internal_zzob.zzxq()) {
            ...
            zzxh.zzxn();
            this.zzaIg.execute(new C04061(this, zzxh));
        }
    }
