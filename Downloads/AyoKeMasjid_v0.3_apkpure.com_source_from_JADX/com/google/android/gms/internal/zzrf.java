...
public interface zzrf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzrf {
        ...
        private static class zza implements zzrf {
        ...
        public static zzrf zzdU(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzrf)) ? new zza(iBinder) : (zzrf) queryLocalInterface;
        }
