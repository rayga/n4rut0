...
public class zzqk {
    ...
    class C08121 implements zzqq {
        final /* synthetic */ zzqi zzaTB;
        final /* synthetic */ zza zzaTC;
        final /* synthetic */ zzqk zzaTD;

        C08121(zzqk com_google_android_gms_internal_zzqk, zzqi com_google_android_gms_internal_zzqi, zza com_google_android_gms_internal_zzqk_zza) {
    ...
    class zzb extends zzqx {
        ...
        protected void zza(zzqo com_google_android_gms_internal_zzqo) {
            ...
            if (zzBw.getStatus() != Status.zzaaD || zzBw.zzBx() != com.google.android.gms.internal.zzqo.zza.zza.NETWORK || zzBw.zzBy() == null || zzBw.zzBy().length <= 0) {
                zzbg.m17v("Response status: " + (zzBw.getStatus().isSuccess() ? "SUCCESS" : "FAILURE"));
                if (zzBw.getStatus().isSuccess()) {
                    zzbg.m17v("Response source: " + zzBw.zzBx().toString());
                    zzbg.m17v("Response size: " + zzBw.zzBy().length);
                }
                this.zzaTD.zza(zzBw.zzBz(), this.zzaTE);
                return;
            }
            this.zzaTD.zzaTy.zze(zzBw.zzBz().zzBr(), zzBw.zzBy());
            zzbg.m17v("Resource successfully load from Network.");
    ...
    void zza(zzqi com_google_android_gms_internal_zzqi, zza com_google_android_gms_internal_zzqk_zza) {
        this.zzaTy.zza(com_google_android_gms_internal_zzqi.zzBr(), com_google_android_gms_internal_zzqi.zzBp(), zzqm.zzaTG, new C08121(this, com_google_android_gms_internal_zzqi, com_google_android_gms_internal_zzqk_zza));
    }
