...
public class zzfy extends zzfw {
    ...
    class C03681 implements Runnable {
        ...
        C03681(zzfy com_google_android_gms_internal_zzfy, zzfx com_google_android_gms_internal_zzfx) {
    ...
    protected void zzh(long j) throws zza {
        ...
        zzhu.zzHK.post(new C03681(this, com_google_android_gms_internal_zzfx));
        zzg(j);
