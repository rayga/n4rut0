...
public class zzis extends WebView implements OnGlobalLayoutListener, DownloadListener, zzip {
    ...
    class C03951 implements Runnable {
        ...
        C03951(zzis com_google_android_gms_internal_zzis) {
    ...
    public void destroy() {
        synchronized (this.zzpc) {
            ...
            zzhn();
            this.zzJn = true;
            zzb.m14v("Initiating WebView self destruct sequence in 3...");
            this.zzCq.zzhd();
        }
    }
    ...
    public void zzb(String str, JSONObject jSONObject) {
        ...
        stringBuilder.append(");");
        zzb.m14v("Dispatching AFMA event: " + stringBuilder.toString());
    ...
    public void zzgX() {
        synchronized (this.zzpc) {
            zzb.m14v("Destroying WebView!");
            zzhu.zzHK.post(new C03951(this));
        }
    }
