...
public class zzgf implements Callable<zzhj> {
    ...
    class C03732 implements Runnable {
        ...
        C03732(zzgf com_google_android_gms_internal_zzgf, zzie com_google_android_gms_internal_zzie, String str) {
    ...
    class C07781 implements zzdg {
        final /* synthetic */ zzbb zzCY;
        final /* synthetic */ zzb zzCZ;
        final /* synthetic */ zzie zzDa;
        final /* synthetic */ zzgf zzDb;

        C07781(zzgf com_google_android_gms_internal_zzgf, zzbb com_google_android_gms_internal_zzbb, zzb com_google_android_gms_internal_zzgf_zzb, zzie com_google_android_gms_internal_zzie) {
            this.zzDb = com_google_android_gms_internal_zzgf;
        ...
        public void zza(zzip com_google_android_gms_internal_zzip, Map<String, String> map) {
            ...
            this.zzDb.zzB(0);
            zzx.zza(this.zzDb.zzft(), (Object) "Unable to set the ad state error!");
            this.zzDa.zzf(null);
        }
    }

    /* renamed from: com.google.android.gms.internal.zzgf.3 */
    class C07793 implements zzdg {
        final /* synthetic */ zzgf zzDb;
        final /* synthetic */ zzf zzDe;

        C07793(zzgf com_google_android_gms_internal_zzgf, zzf com_google_android_gms_ads_internal_formats_zzf) {
            this.zzDb = com_google_android_gms_internal_zzgf;
    ...
    class C07804 implements com.google.android.gms.internal.zzig.zza<zzc, com.google.android.gms.ads.internal.formats.zza> {
        final /* synthetic */ zzgf zzDb;
        ...
        C07804(zzgf com_google_android_gms_internal_zzgf, String str, Integer num, Integer num2, int i) {
            this.zzDb = com_google_android_gms_internal_zzgf;
            this.zzDf = str;
            this.zzDg = num;
            this.zzDh = num2;
    ...
    class C07815 implements com.google.android.gms.internal.zzhy.zza<zzc> {
        final /* synthetic */ zzgf zzDb;
        final /* synthetic */ boolean zzDj;
        final /* synthetic */ String zzzF;

        C07815(zzgf com_google_android_gms_internal_zzgf, boolean z, String str) {
            this.zzDb = com_google_android_gms_internal_zzgf;
            this.zzDj = z;
            this.zzzF = str;
        }
    ...
    private com.google.android.gms.ads.internal.formats.zzh.zza zza(zzbb com_google_android_gms_internal_zzbb, zza com_google_android_gms_internal_zzgf_zza, JSONObject jSONObject) throws ExecutionException, InterruptedException, JSONException {
        ...
        if (zza == null) {
            com.google.android.gms.ads.internal.util.client.zzb.m13e("Failed to retrieve ad assets.");
            return null;
        }
    ...
    private zzih<zzc> zza(JSONObject jSONObject, boolean z, boolean z2) throws JSONException {
        ...
        if (!TextUtils.isEmpty(string)) {
            return z2 ? new zzif(new zzc(null, Uri.parse(string))) : this.zzCT.zza(string, new C07815(this, z, string));
        } else {
            zza(0, z);
    ...
    private void zza(com.google.android.gms.ads.internal.formats.zzh.zza com_google_android_gms_ads_internal_formats_zzh_zza, zzbb com_google_android_gms_internal_zzbb) {
        if (com_google_android_gms_ads_internal_formats_zzh_zza instanceof zzf) {
            ...
            zzdg c07793 = new C07793(this, com_google_android_gms_ads_internal_formats_zzf);
            com_google_android_gms_internal_zzgf_zzb.zzDk = c07793;
            com_google_android_gms_internal_zzbb.zza("/nativeAdCustomClick", c07793);
        }
    }
    ...
    private JSONObject zzb(zzbb com_google_android_gms_internal_zzbb) throws TimeoutException, JSONException {
        ...
        zzb com_google_android_gms_internal_zzgf_zzb = new zzb(this);
        zzdg c07781 = new C07781(this, com_google_android_gms_internal_zzbb, com_google_android_gms_internal_zzgf_zzb, com_google_android_gms_internal_zzie);
        com_google_android_gms_internal_zzgf_zzb.zzDk = c07781;
        com_google_android_gms_internal_zzbb.zza("/nativeAdPreProcess", c07781);
    ...
    protected zza zzd(JSONObject jSONObject) throws JSONException, TimeoutException {
        ...
        if ("3".equals(string)) {
            ...
            zzie com_google_android_gms_internal_zzie = new zzie();
            zzhu.zzHK.post(new C03732(this, com_google_android_gms_internal_zzie, string2));
            if (com_google_android_gms_internal_zzie.get(zzCS, TimeUnit.MILLISECONDS) != null) {
                return new zzgi(z);
            }
            com.google.android.gms.ads.internal.util.client.zzb.m13e("No handler for custom template: " + jSONObject.getString("custom_template_id"));
        } else {
            zzB(0);
        }
        return null;
    ...
    public zzih<com.google.android.gms.ads.internal.formats.zza> zze(JSONObject jSONObject) throws JSONException {
        ...
        return zzig.zza(zza(optJSONObject, Frg_Qiblat_Map.sARGUMENT_IMAGE_CODE, false, false), new C07804(this, optString, zzb(optJSONObject, "bg_color"), zzb, optInt));
    }
