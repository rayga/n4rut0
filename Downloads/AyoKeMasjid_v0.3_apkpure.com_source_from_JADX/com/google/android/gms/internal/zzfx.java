...
public class zzfx implements Runnable {
    ...
    public void zza(AdResponseParcel adResponseParcel, zzix com_google_android_gms_internal_zzix) {
        ...
        this.zzoL.loadDataWithBaseURL(TextUtils.isEmpty(adResponseParcel.zzAT) ? null : zzp.zzbx().zzaw(adResponseParcel.zzAT), adResponseParcel.body, "text/html", Key.STRING_CHARSET_NAME, null);
    }
