...
public class zzdh implements zzdg {
    ...
    class C03361 implements Runnable {
        ...
        class C03351 implements Runnable {
            ...
            final /* synthetic */ C03361 zzwX;

            C03351(C03361 c03361, JSONObject jSONObject) {
                this.zzwX = c03361;
        ...
        C03361(zzdh com_google_android_gms_internal_zzdh, Map map, zzip com_google_android_gms_internal_zzip) {
        ...
        public void run() {
            ...
            if (zzV == null) {
                com.google.android.gms.ads.internal.util.client.zzb.m13e("Response should not be null.");
            } else {
                zzhu.zzHK.post(new C03351(this, zzV));
            }
        }
    }
    ...
    public JSONObject zzV(String str) {
        try {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.m13e("The request is not a valid JSON.");
            try {
    ...
    public void zza(zzip com_google_android_gms_internal_zzip, Map<String, String> map) {
        zzht.zza(new C03361(this, map, com_google_android_gms_internal_zzip));
    }
