...
public final class zzby {
    ...
    static {
        ...
        zzuk = zzbu.zza("gads:video_stream_cache:limit_space", (int) MediaRouterJellybean.ROUTE_TYPE_USER);
        zzul = zzbu.zza("gads:video_stream_exo_cache:buffer_size", (int) MediaRouterJellybean.ROUTE_TYPE_USER);
        zzum = zzbu.zzb("gads:video_stream_cache:limit_time_sec", 300);
        zzun = zzbu.zzb("gads:video_stream_cache:notify_interval_millis", 1000);
        zzuo = zzbu.zza("gads:video_stream_cache:connect_timeout_millis", (int) StatusCodes.AUTH_DISABLED);
        zzup = zzbu.zza("gads:video:metric_reporting_enabled", Boolean.valueOf(false));
        zzuq = zzbu.zzc("gads:video:metric_frame_hash_times", BuildConfig.FLAVOR);
        zzur = zzbu.zzb("gads:video:metric_frame_hash_time_leniency", 500);
        ...
        zzuY = zzbu.zzb("gads:device_info_caching_expiry_ms:expiry", 300000);
        ...
        zzve = zzbu.zzb("gads:network:cache_prediction_duration_s", 300);
    }
