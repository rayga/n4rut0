...
public abstract class zzfz extends zzhq {
    ...
    class C03691 implements Runnable {
        ...
        C03691(zzfz com_google_android_gms_internal_zzfz) {
    ...
    class C03702 implements Runnable {
        ...
        C03702(zzfz com_google_android_gms_internal_zzfz, zzhj com_google_android_gms_internal_zzhj) {
            this.zzCH = com_google_android_gms_internal_zzfz;
    ...
    public void zzdG() {
        ...
        synchronized (this.zzpc) {
            ...
            try {
                ...
                zzhu.zzHK.post(new C03691(this));
                i = errorCode;
            }
            zzhu.zzHK.post(new C03702(this, zzz(i)));
        }
    }
