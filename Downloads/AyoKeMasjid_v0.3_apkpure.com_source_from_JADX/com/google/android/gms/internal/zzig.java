...
public class zzig {
    ...
    static class C03931 implements Runnable {
        ...
        C03931(zzie com_google_android_gms_internal_zzie, zza com_google_android_gms_internal_zzig_zza, zzih com_google_android_gms_internal_zzih) {
    ...
    public static <A, B> zzih<B> zza(zzih<A> com_google_android_gms_internal_zzih_A, zza<A, B> com_google_android_gms_internal_zzig_zza_A__B) {
        ...
        com_google_android_gms_internal_zzih_A.zzc(new C03931(com_google_android_gms_internal_zzie, com_google_android_gms_internal_zzig_zza_A__B, com_google_android_gms_internal_zzih_A));
