...
public class zzhw {
    ...
    class C03901 implements OnClickListener {
        ...
        C03901(zzhw com_google_android_gms_internal_zzhw, String str) {
    ...
    class C03912 implements OnClickListener {
        ...
        C03912(zzhw com_google_android_gms_internal_zzhw) {
            this.zzHT = com_google_android_gms_internal_zzhw;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C03901(this, zzaA));
            builder.setNegativeButton("Close", new C03912(this));
            builder.create().show();
            return;
        }
    ...
    void zza(int i, float f, float f2) {
        if (i == 0) {
            ...
            if (i == 2) {
                ...
                if (this.zzHQ - this.zzHR > BitmapDescriptorFactory.HUE_ORANGE * this.zzzP) {
                    this.mState = -1;
                    return;
                }
