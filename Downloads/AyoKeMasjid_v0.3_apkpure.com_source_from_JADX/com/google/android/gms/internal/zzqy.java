...
public class zzqy implements Runnable {
    ...
    boolean zzBY() {
        if (!zzbf("android.permission.INTERNET")) {
            zzbg.m16e("Missing android.permission.INTERNET. Please add the following declaration to your AndroidManifest.xml: <uses-permission android:name=\"android.permission.INTERNET\" />");
            return false;
            ...
            zzbg.m16e("Missing android.permission.ACCESS_NETWORK_STATE. Please add the following declaration to your AndroidManifest.xml: <uses-permission android:name=\"android.permission.ACCESS_NETWORK_STATE\" />");
            return false;
        }
    }
    ...
    void zzeP() {
        if (zzBY()) {
            zzbg.m17v("NetworkLoader: Starting to load resource from Network.");
            ...
            try {
                ...
                try {
                    ...
                    zzbg.m17v("NetworkLoader: Resource loaded.");
                } catch (Throwable e) {
                ...
                zzbg.m16e("NetworkLoader: No data is retrieved from the given url: " + zzt);
                this.zzaUv.zza(zza.SERVER_ERROR);
            } catch (Throwable e3) {
