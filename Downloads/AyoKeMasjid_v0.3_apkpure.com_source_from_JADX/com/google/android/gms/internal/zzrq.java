...
public final class zzrq {
    ...
    private static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < '\u0080' && i5 < i4) {
                ...
                i6 = r6 + 1;
                bArr[r6] = (byte) ((charAt2 & 63) | Barcode.ITF);
            } else if ((charAt2 < '\ud800' || '\udfff' < charAt2) && i5 <= i4 - 3) {
                i6 = i5 + 1;
                bArr[i5] = (byte) ((charAt2 >>> 12) | 480);
                i5 = i6 + 1;
                bArr[i6] = (byte) (((charAt2 >>> 6) & 63) | Barcode.ITF);
                i6 = i5 + 1;
                bArr[i5] = (byte) ((charAt2 & 63) | Barcode.ITF);
            } else if (i5 <= i4 - 4) {
                if (i3 + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt)) {
                        ...
                        i5 = i6 + 1;
                        bArr[i6] = (byte) (((toCodePoint >>> 12) & 63) | Barcode.ITF);
                        r6 = i5 + 1;
                        bArr[i5] = (byte) (((toCodePoint >>> 6) & 63) | Barcode.ITF);
                        i6 = r6 + 1;
                        bArr[r6] = (byte) ((toCodePoint & 63) | Barcode.ITF);
                    }
                }
    ...
    private static void zzb(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (charAt < '\u0080') {
                ...
                byteBuffer.put((byte) ((charAt & 63) | Barcode.ITF));
            } else if (charAt < '\ud800' || '\udfff' < charAt) {
                byteBuffer.put((byte) ((charAt >>> 12) | 480));
                byteBuffer.put((byte) (((charAt >>> 6) & 63) | Barcode.ITF));
                byteBuffer.put((byte) ((charAt & 63) | Barcode.ITF));
            } else {
                if (i + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt, charAt2)) {
                        ...
                        byteBuffer.put((byte) (((toCodePoint >>> 12) & 63) | Barcode.ITF));
                        byteBuffer.put((byte) (((toCodePoint >>> 6) & 63) | Barcode.ITF));
                        byteBuffer.put((byte) ((toCodePoint & 63) | Barcode.ITF));
                    }
                }
    ...
    public void zzaa(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzlu((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | Barcode.ITF);
            j >>>= 7;
        }
        zzlu((int) j);
    }
    ...
    public void zzac(long j) throws IOException {
        zzlu(((int) j) & MotionEventCompat.ACTION_MASK);
        zzlu(((int) (j >> 8)) & MotionEventCompat.ACTION_MASK);
        zzlu(((int) (j >> 16)) & MotionEventCompat.ACTION_MASK);
        zzlu(((int) (j >> 24)) & MotionEventCompat.ACTION_MASK);
        zzlu(((int) (j >> 32)) & MotionEventCompat.ACTION_MASK);
        zzlu(((int) (j >> 40)) & MotionEventCompat.ACTION_MASK);
        zzlu(((int) (j >> 48)) & MotionEventCompat.ACTION_MASK);
        zzlu(((int) (j >> 56)) & MotionEventCompat.ACTION_MASK);
    }
    ...
    public void zzlw(int i) throws IOException {
        while ((i & -128) != 0) {
            zzlu((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | Barcode.ITF);
            i >>>= 7;
        }
        zzlu(i);
    }
    ...
    public void zzly(int i) throws IOException {
        zzlu(i & MotionEventCompat.ACTION_MASK);
        zzlu((i >> 8) & MotionEventCompat.ACTION_MASK);
        zzlu((i >> 16) & MotionEventCompat.ACTION_MASK);
        zzlu((i >> 24) & MotionEventCompat.ACTION_MASK);
    }
