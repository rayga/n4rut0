...
public abstract class zzal extends zzak {
    ...
    private static String zzb(byte[] bArr, String str) throws zza {
        try {
            return new String(zzno.zzc(bArr, str), Key.STRING_CHARSET_NAME);
        } catch (Throwable e) {
            throw new zza(e);
        } catch (Throwable e2) {
            throw new zza(e2);
    ...
    L_0x001d:
        r0 = r6.zzmU;	 Catch:{ zza -> 0x0079, IOException -> 0x0073 }
        r1 = r6.zzmV;	 Catch:{ zza -> 0x0079, IOException -> 0x0073 }
