...
public class zzhy {
    ...
    static class C07881 implements zza {
        C07881() {
        }
    ...
    class C07892 implements com.google.android.gms.internal.zzm.zza {
        final /* synthetic */ zzc zzIh;
        final /* synthetic */ zzhy zzIi;
        final /* synthetic */ String zzxv;

        C07892(zzhy com_google_android_gms_internal_zzhy, String str, zzc com_google_android_gms_internal_zzhy_zzc) {
    ...
    private static class zzb<T> extends zzk<InputStream> {
        ...
        class C07901 implements com.google.android.gms.internal.zzm.zza {
            final /* synthetic */ com.google.android.gms.internal.zzm.zzb zzIl;
            final /* synthetic */ zza zzIm;

            C07901(com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, zza com_google_android_gms_internal_zzhy_zza) {
        ...
        public zzb(String str, zza<T> com_google_android_gms_internal_zzhy_zza_T, com.google.android.gms.internal.zzm.zzb<T> com_google_android_gms_internal_zzm_zzb_T) {
            super(0, str, new C07901(com_google_android_gms_internal_zzm_zzb_T, com_google_android_gms_internal_zzhy_zza_T));
    ...
    class C11423 extends zzab {
        final /* synthetic */ zzhy zzIi;
        final /* synthetic */ Map zzIj;

        C11423(zzhy com_google_android_gms_internal_zzhy, String str, com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, com.google.android.gms.internal.zzm.zza com_google_android_gms_internal_zzm_zza, Map map) {
            this.zzIi = com_google_android_gms_internal_zzhy;
            this.zzIj = map;
    ...
    public zzih<String> zzb(String str, Map<String, String> map) {
        Object com_google_android_gms_internal_zzhy_zzc = new zzc();
        zzIf.zze(new C11423(this, str, com_google_android_gms_internal_zzhy_zzc, new C07892(this, str, com_google_android_gms_internal_zzhy_zzc), map));
        return com_google_android_gms_internal_zzhy_zzc;
    }
}
