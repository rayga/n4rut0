...
public class zzey extends zzfb {
    ...
    class C03631 implements OnClickListener {
        ...
        C03631(zzey com_google_android_gms_internal_zzey, String str, String str2) {
    ...
    class C03642 implements OnClickListener {
        ...
        C03642(zzey com_google_android_gms_internal_zzey) {
            this.zzzH = com_google_android_gms_internal_zzey;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzp.zzbx().zzay(zzag)) {
                    ...
                    zzL.setTitle(zzp.zzbA().zzc(C0197R.string.store_picture_title, "Save image"));
                    zzL.setMessage(zzp.zzbA().zzc(C0197R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzL.setPositiveButton(zzp.zzbA().zzc(C0197R.string.accept, "Accept"), new C03631(this, str, zzag));
                    zzL.setNegativeButton(zzp.zzbA().zzc(C0197R.string.decline, "Decline"), new C03642(this));
                    zzL.create().show();
                    return;
                }
