...
public class zziu extends WebChromeClient {
    ...
    static class C03961 implements OnCancelListener {
        final /* synthetic */ JsResult zzJx;

        C03961(JsResult jsResult) {
            this.zzJx = jsResult;
        }
    ...
    static class C03972 implements OnClickListener {
        final /* synthetic */ JsResult zzJx;

        C03972(JsResult jsResult) {
            this.zzJx = jsResult;
        }
    ...
    static class C03983 implements OnClickListener {
        final /* synthetic */ JsResult zzJx;

        C03983(JsResult jsResult) {
            this.zzJx = jsResult;
        }
    ...
    static class C03994 implements OnCancelListener {
        final /* synthetic */ JsPromptResult zzJy;

        C03994(JsPromptResult jsPromptResult) {
    ...
    static class C04005 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzJy;

        C04005(JsPromptResult jsPromptResult) {
            this.zzJy = jsPromptResult;
        }
    ...
    static class C04016 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzJy;
        final /* synthetic */ EditText zzJz;

        C04016(JsPromptResult jsPromptResult, EditText editText) {
            this.zzJy = jsPromptResult;
            this.zzJz = editText;
        }
    ...
    private static void zza(Builder builder, String str, JsResult jsResult) {
        builder.setMessage(str).setPositiveButton(17039370, new C03983(jsResult)).setNegativeButton(17039360, new C03972(jsResult)).setOnCancelListener(new C03961(jsResult)).create().show();
    }
    ...
    private static void zza(Context context, Builder builder, String str, String str2, JsPromptResult jsPromptResult) {
        ...
        builder.setView(linearLayout).setPositiveButton(17039370, new C04016(jsPromptResult, editText)).setNegativeButton(17039360, new C04005(jsPromptResult)).setOnCancelListener(new C03994(jsPromptResult)).create().show();
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C04027.zzJA[consoleMessage.messageLevel().ordinal()]) {
