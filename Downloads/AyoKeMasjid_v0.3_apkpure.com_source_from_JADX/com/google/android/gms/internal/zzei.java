...
public interface zzei extends IInterface {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    zza(com.google.android.gms.dynamic.zzd.zza.zzbk(data.readStrongBinder()), data.readInt() != 0 ? AdSizeParcel.CREATOR.zzc(data) : null, data.readInt() != 0 ? AdRequestParcel.CREATOR.zzb(data) : null, data.readString(), com.google.android.gms.internal.zzej.zza.zzG(data.readStrongBinder()));
                ...
                case Barcode.SMS /*6*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                    zza(com.google.android.gms.dynamic.zzd.zza.zzbk(data.readStrongBinder()), data.readInt() != 0 ? AdSizeParcel.CREATOR.zzc(data) : null, data.readInt() != 0 ? AdRequestParcel.CREATOR.zzb(data) : null, data.readString(), data.readString(), com.google.android.gms.internal.zzej.zza.zzG(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case Barcode.TEXT /*7*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                    zza(com.google.android.gms.dynamic.zzd.zza.zzbk(data.readStrongBinder()), data.readInt() != 0 ? AdRequestParcel.CREATOR.zzb(data) : null, data.readString(), data.readString(), com.google.android.gms.internal.zzej.zza.zzG(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case Barcode.URL /*8*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                ...
                case Barcode.GEO /*10*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                    zza(com.google.android.gms.dynamic.zzd.zza.zzbk(data.readStrongBinder()), data.readInt() != 0 ? AdRequestParcel.CREATOR.zzb(data) : null, data.readString(), com.google.android.gms.ads.internal.reward.mediation.client.zza.zza.zzad(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    return true;
                ...
                case Place.TYPE_BUS_STATION /*14*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                    zza(com.google.android.gms.dynamic.zzd.zza.zzbk(data.readStrongBinder()), data.readInt() != 0 ? AdRequestParcel.CREATOR.zzb(data) : null, data.readString(), data.readString(), com.google.android.gms.internal.zzej.zza.zzG(data.readStrongBinder()), data.readInt() != 0 ? NativeAdOptionsParcel.CREATOR.zzf(data) : null, data.createStringArrayList());
                    reply.writeNoException();
                    return true;
    ...
    void zza(zzd com_google_android_gms_dynamic_zzd, AdRequestParcel adRequestParcel, String str, zzej com_google_android_gms_internal_zzej) throws RemoteException;

    void zza(zzd com_google_android_gms_dynamic_zzd, AdRequestParcel adRequestParcel, String str, String str2, zzej com_google_android_gms_internal_zzej) throws RemoteException;

    void zza(zzd com_google_android_gms_dynamic_zzd, AdRequestParcel adRequestParcel, String str, String str2, zzej com_google_android_gms_internal_zzej, NativeAdOptionsParcel nativeAdOptionsParcel, List<String> list) throws RemoteException;

    void zza(zzd com_google_android_gms_dynamic_zzd, AdSizeParcel adSizeParcel, AdRequestParcel adRequestParcel, String str, zzej com_google_android_gms_internal_zzej) throws RemoteException;

    void zza(zzd com_google_android_gms_dynamic_zzd, AdSizeParcel adSizeParcel, AdRequestParcel adRequestParcel, String str, String str2, zzej com_google_android_gms_internal_zzej) throws RemoteException;
