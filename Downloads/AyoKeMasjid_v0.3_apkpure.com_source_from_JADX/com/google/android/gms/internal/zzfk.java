...
public class zzfk implements zzfi {
    ...
    class C03671 implements Runnable {
        ...
        class C03661 extends WebViewClient {
            final /* synthetic */ C03671 zzBI;
            final /* synthetic */ WebView zzrZ;

            C03661(C03671 c03671, WebView webView) {
                this.zzBI = c03671;
                this.zzrZ = webView;
            }
        ...
        C03671(zzfk com_google_android_gms_internal_zzfk, String str, String str2) {
        ...
        public void run() {
            ...
            zzfb.setWebViewClient(new C03661(this, zzfb));
            this.zzBH.zzBE.add(zzfb);
            zzfb.loadDataWithBaseURL(this.zzBF, this.zzBG, "text/html", Key.STRING_CHARSET_NAME, null);
    ...
    public void zza(String str, String str2, String str3) {
        ...
        zzhu.zzHK.post(new C03671(this, str2, str3));
    }
