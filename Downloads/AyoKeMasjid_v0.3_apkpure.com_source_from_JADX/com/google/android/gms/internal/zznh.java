...
public interface zznh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznh {
        ...
        private static class zza implements zznh {
            ...
            public void zzr(Status status) throws RemoteException {
        ...
        public static zznh zzbJ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    zzr(data.readInt() != 0 ? (Status) Status.CREATOR.createFromParcel(data) : null);
