...
public interface zzny extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzny {
        ...
        private static class zza implements zzny {
        ...
        public static zzny zzbT(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzny)) ? new zza(iBinder) : (zzny) queryLocalInterface;
        }
