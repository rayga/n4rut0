...
public class zzbk extends Thread {
    ...
    class C03281 implements Runnable {
        ...
        C03281(zzbk com_google_android_gms_internal_zzbk, View view) {
    ...
    class C03302 implements Runnable {
        ...
        class C03291 implements ValueCallback<String> {
            final /* synthetic */ C03302 zzsa;

            C03291(C03302 c03302) {
                this.zzsa = c03302;
            }
        ...
        C03302(zzbk com_google_android_gms_internal_zzbk, zzbh com_google_android_gms_internal_zzbh, WebView webView) {
            this.zzrW = com_google_android_gms_internal_zzbk;
            this.zzrY = com_google_android_gms_internal_zzbh;
            this.zzrZ = webView;
            this.zzrX = new C03291(this);
        }
    ...
    L_0x000a:
        r0 = r3.zzrP;	 Catch:{ Throwable -> 0x0018 }
        r0 = r0.getActivity();	 Catch:{ Throwable -> 0x0018 }
        if (r0 != 0) goto L_0x0038;
    L_0x0012:
        r0 = "ContentFetchThread: no activity";
        com.google.android.gms.ads.internal.util.client.zzb.zzaC(r0);	 Catch:{ Throwable -> 0x0018 }
        goto L_0x0000;
    L_0x0018:
        r0 = move-exception;
    ...
    L_0x0024:
        ...
        monitor-enter(r1);
    L_0x0027:
        r0 = r3.zzrO;	 Catch:{ all -> 0x004f }
        if (r0 == 0) goto L_0x004d;
    L_0x002b:
        r0 = "ContentFetchTask: waiting";
        com.google.android.gms.ads.internal.util.client.zzb.zzaC(r0);	 Catch:{ InterruptedException -> 0x0036 }
        r0 = r3.zzpc;	 Catch:{ InterruptedException -> 0x0036 }
    ...
    L_0x003b:
        r0 = r3.zzrS;	 Catch:{ Throwable -> 0x0018 }
        r0 = r0 * 1000;
    ...
    boolean zza(WebView webView, zzbh com_google_android_gms_internal_zzbh) {
        ...
        com_google_android_gms_internal_zzbh.zzcp();
        webView.post(new C03302(this, com_google_android_gms_internal_zzbh, webView));
        return true;
    }
    ...
    boolean zzf(View view) {
        ...
        view.post(new C03281(this, view));
        return true;
    }
