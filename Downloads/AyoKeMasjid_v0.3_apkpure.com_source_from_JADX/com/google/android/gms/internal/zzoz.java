...
public interface zzoz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzoz {
        ...
        private static class zza implements zzoz {
            ...
            public void zza(zzoy com_google_android_gms_internal_zzoy) throws RemoteException {
                IBinder iBinder = null;
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    if (com_google_android_gms_internal_zzoy != null) {
                        iBinder = com_google_android_gms_internal_zzoy.asBinder();
                    }
        ...
        public static zzoz zzdc(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzoz)) ? new zza(iBinder) : (zzoz) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    StartScanRequest zzft;
                    data.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    if (data.readInt() != 0) {
                        zzft = StartScanRequest.CREATOR.zzft(data);
                    }
                    zza(zzft);
                    return true;
                case CompletionEvent.STATUS_CONFLICT /*2*/:
                    StopScanRequest zzfu;
                    data.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    if (data.readInt() != 0) {
                        zzfu = StopScanRequest.CREATOR.zzfu(data);
                    }
                    zza(zzfu);
                    return true;
                case CompletionEvent.STATUS_CANCELED /*3*/:
                    EnableTargetRequest zzfr;
                    data.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    if (data.readInt() != 0) {
                        zzfr = EnableTargetRequest.CREATOR.zzfr(data);
                    }
                    zza(zzfr);
                    return true;
                case Barcode.PHONE /*4*/:
                    DisableTargetRequest zzfp;
                    data.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    if (data.readInt() != 0) {
                        zzfp = DisableTargetRequest.CREATOR.zzfp(data);
                    }
                    zza(zzfp);
                    return true;
                case Barcode.PRODUCT /*5*/:
                    ...
                    data.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    if (data.readInt() != 0) {
                        zzfn = ConnectRequest.CREATOR.zzfn(data);
                    }
                    zza(zzfn);
                    return true;
                case Barcode.SMS /*6*/:
                    DisconnectRequest zzfq;
                    data.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    if (data.readInt() != 0) {
                        zzfq = DisconnectRequest.CREATOR.zzfq(data);
                    }
                    zza(zzfq);
                    return true;
                case Barcode.TEXT /*7*/:
                    SendDataRequest zzfs;
                    data.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    if (data.readInt() != 0) {
                        zzfs = SendDataRequest.CREATOR.zzfs(data);
                    }
                    zza(zzfs);
                    return true;
                case Barcode.URL /*8*/:
                    data.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    if (data.readInt() != 0) {
                        continueConnectRequest = ContinueConnectRequest.CREATOR.zzfo(data);
                    }
                ...
                case Barcode.GEO /*10*/:
                    data.enforceInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapService");
                    zza(com.google.android.gms.internal.zzoy.zza.zzdb(data.readStrongBinder()));
                    return true;
                case 1598968902:
    ...
    void zza(zzoy com_google_android_gms_internal_zzoy) throws RemoteException;
