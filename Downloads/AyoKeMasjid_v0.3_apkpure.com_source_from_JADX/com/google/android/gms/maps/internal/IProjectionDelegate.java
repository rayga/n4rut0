        ...
        private static class zza implements IProjectionDelegate {
            ...
            public LatLng fromScreenLocation(zzd point) throws RemoteException {
                ...
                try {
                    ...
                    if (obtain2.readInt() != 0) {
                        latLng = LatLng.CREATOR.zzfa(obtain2);
                    }
                    obtain2.recycle();
                    obtain.recycle();
                    return latLng;
            ...
            public VisibleRegion getVisibleRegion() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    VisibleRegion zzfl = obtain2.readInt() != 0 ? VisibleRegion.CREATOR.zzfl(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return zzfl;
                } catch (Throwable th) {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    ...
                    LatLng fromScreenLocation = fromScreenLocation(com.google.android.gms.dynamic.zzd.zza.zzbk(data.readStrongBinder()));
                ...
                case CompletionEvent.STATUS_CONFLICT /*2*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
                    zzd toScreenLocation = toScreenLocation(data.readInt() != 0 ? LatLng.CREATOR.zzfa(data) : null);
                    reply.writeNoException();
