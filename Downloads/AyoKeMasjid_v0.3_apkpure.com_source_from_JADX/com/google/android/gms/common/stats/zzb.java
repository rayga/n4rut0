...
public class zzb {
    ...
    static {
        zzadT = new Object();
        zzafz = new ComponentName(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE, "com.google.android.gms.common.stats.GmsCoreStatsService");
    }
    ...
    private zzb() {
        ...
        this.zzafA = new zze(Barcode.UPC_E, ((Long) zza.zzafI.get()).longValue());
    }
    ...
    private boolean zzb(Context context, Intent intent) {
        ...
        return (component == null || (zzd.zzacF && GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE.equals(component.getPackageName()))) ? false : zzll.zzi(context, component.getPackageName());
    }

    private static ServiceInfo zzc(Context context, Intent intent) {
        List queryIntentServices = context.getPackageManager().queryIntentServices(intent, Barcode.ITF);
