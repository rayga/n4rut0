...
public final class zzf {
    ...
    public Set<Scope> zzb(Api<?> api) {
        zza com_google_android_gms_common_internal_zzf_zza = (zza) this.zzadd.get(api);
        if (com_google_android_gms_common_internal_zzf_zza == null || com_google_android_gms_common_internal_zzf_zza.zzZp.isEmpty()) {
            return this.zzYY;
        }
