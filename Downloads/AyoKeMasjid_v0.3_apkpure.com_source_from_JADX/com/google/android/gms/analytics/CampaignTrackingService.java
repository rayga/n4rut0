...
public class CampaignTrackingService extends Service {
    ...
    class C02311 implements Runnable {
        ...
        C02311(CampaignTrackingService campaignTrackingService, zzaf com_google_android_gms_analytics_internal_zzaf, Handler handler, int i) {
    ...
    class C02322 implements Runnable {
        ...
        C02322(CampaignTrackingService campaignTrackingService, zzaf com_google_android_gms_analytics_internal_zzaf, Handler handler, int i) {
            this.zzKo = campaignTrackingService;
            this.zzKh = com_google_android_gms_analytics_internal_zzaf;
            this.zzt = handler;
            this.zzKf = i;
    ...
    class C02333 implements Runnable {
        ...
        C02333(CampaignTrackingService campaignTrackingService, int i, zzaf com_google_android_gms_analytics_internal_zzaf) {
            this.zzKo = campaignTrackingService;
            this.zzKf = i;
            this.zzKh = com_google_android_gms_analytics_internal_zzaf;
        }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            zzX.zzig().zzf(new C02311(this, zzie, handler, startId));
        } else {
            ...
            zzX.zzhz().zza(str, new C02322(this, zzie, handler, startId));
        }
        return 2;
    }

    protected void zza(zzaf com_google_android_gms_analytics_internal_zzaf, Handler handler, int i) {
        handler.post(new C02333(this, i, com_google_android_gms_analytics_internal_zzaf));
    }
}
