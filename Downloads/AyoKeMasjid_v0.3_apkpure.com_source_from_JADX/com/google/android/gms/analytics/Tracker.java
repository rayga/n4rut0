...
public class Tracker extends zzd {
    ...
    class C02351 implements Runnable {
        ...
        C02351(Tracker tracker, Map map, boolean z, String str, long j, boolean z2, boolean z3, String str2) {
            this.zzKU = tracker;
            this.zzKN = map;
            this.zzKO = z;
            this.zzKP = str;
    ...
    Tracker(zzf analytics, String trackingId, zzad rateLimiter) {
        ...
        this.zzvs.put("&a", Integer.toString(new Random().nextInt(Strategy.TTL_SECONDS_INFINITE) + 1));
        if (rateLimiter == null) {
    ...
    public String get(String key) {
        ...
        return key.equals("&aiid") ? zzil().zziL().zzxA() : null;
    }
    ...
    public void send(Map<String, String> params) {
        ...
        zzig().zzf(new C02351(this, hashMap, zzhD, str, currentTimeMillis, isDryRunEnabled, zze, str2));
    }
