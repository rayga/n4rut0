...
public final class zzy {
    ...
    static {
        ...
        zzNd = zza.zza("analytics.max_stored_hits", (int) GamesStatusCodes.STATUS_REQUEST_UPDATE_PARTIAL_SUCCESS, 20000);
        zzNe = zza.zze("analytics.max_stored_hits_per_app", GamesStatusCodes.STATUS_REQUEST_UPDATE_PARTIAL_SUCCESS);
        ...
        zzNw = zza.zze("analytics.max_hit_length.k", AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD);
        zzNx = zza.zze("analytics.max_post_length.k", AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD);
        zzNy = zza.zze("analytics.max_batch_post_length", AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD);
        ...
        zzNF = zza.zzn("analytics.first_party_experiment_id", BuildConfig.FLAVOR);
