...
public class zzaf extends zzd {
    ...
    protected String zzk(Object obj) {
        ...
        if (!(l instanceof Long)) {
            ...
            stringBuilder.append(Math.round(Math.pow(Utils.DEF_IMSAAK_INTERVAL, (double) (valueOf.length() - 1))));
            stringBuilder.append("...");
            stringBuilder.append(str);
            stringBuilder.append(Math.round(Math.pow(Utils.DEF_IMSAAK_INTERVAL, (double) valueOf.length()) - Utils.AGGRESSIVE_ROUND_SEC));
