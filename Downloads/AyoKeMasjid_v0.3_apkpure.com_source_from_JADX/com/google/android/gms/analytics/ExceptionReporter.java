...
public class ExceptionReporter implements UncaughtExceptionHandler {
    ...
    public ExceptionReporter(Tracker tracker, UncaughtExceptionHandler originalHandler, Context context) {
        if (tracker == null) {
            ...
            zzae.m15v("ExceptionReporter created, original handler is " + (originalHandler == null ? "null" : originalHandler.getClass().getName()));
        }
    }
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        zzae.m15v("Reporting uncaught exception: " + str);
        ...
        zzhu.zzhy();
        if (this.zzKp != null) {
            zzae.m15v("Passing exception to the original handler");
