...
public final class PublisherAdRequest {
    ...
    public static final class Builder {
        ...
        public Builder setContentUrl(String contentUrl) {
            com.google.android.gms.common.internal.zzx.zzb((Object) contentUrl, (Object) "Content URL must be non-null.");
            com.google.android.gms.common.internal.zzx.zzh(contentUrl, "Content URL must be non-empty.");
            boolean z = contentUrl.length() <= Barcode.UPC_A;
            Object[] objArr = new Object[PublisherAdRequest.GENDER_FEMALE];
            objArr[PublisherAdRequest.ERROR_CODE_INTERNAL_ERROR] = Integer.valueOf(Barcode.UPC_A);
