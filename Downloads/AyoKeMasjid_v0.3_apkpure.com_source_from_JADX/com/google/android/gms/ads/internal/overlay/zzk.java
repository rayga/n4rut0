...
public class zzk extends FrameLayout implements zzh {
    ...
    private void zzeV() {
        if (this.zzoL.zzgN() != null && !this.zzBe) {
            this.zzBf = (this.zzoL.zzgN().getWindow().getAttributes().flags & Barcode.ITF) != 0;
            if (!this.zzBf) {
                this.zzoL.zzgN().getWindow().addFlags(Barcode.ITF);
                this.zzBe = true;
            }
        }
    }
    ...
    private void zzeW() {
        if (this.zzoL.zzgN() != null && this.zzBe && !this.zzBf) {
            this.zzoL.zzgN().getWindow().clearFlags(Barcode.ITF);
            this.zzBe = false;
        }
    }
