...
public final class LargeParcelTeleporter implements SafeParcelable {
    ...
    class C02121 implements Runnable {
        ...
        C02121(LargeParcelTeleporter largeParcelTeleporter, OutputStream outputStream, byte[] bArr) {
    ...
    public <T extends SafeParcelable> T zza(Creator<T> creator) {
        if (this.zzEq) {
            if (this.zzEo == null) {
                zzb.m13e("File descriptor is empty, returning null.");
                return null;
            }
    ...
    protected <T> ParcelFileDescriptor zzf(byte[] bArr) {
        try {
            ...
            new Thread(new C02121(this, new AutoCloseOutputStream(createPipe[1]), bArr)).start();
            return createPipe[0];
        } catch (Throwable e) {
            zzb.zzb("Error transporting the ad response", e);
            zzp.zzbA().zzc(e, true);
