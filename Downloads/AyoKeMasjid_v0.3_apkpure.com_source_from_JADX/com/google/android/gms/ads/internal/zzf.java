...
public class zzf extends zzc {
    ...
    class C06841 implements zzb {
        final /* synthetic */ zzhj zzoN;
        final /* synthetic */ zzf zzoO;

        C06841(zzf com_google_android_gms_ads_internal_zzf, zzhj com_google_android_gms_internal_zzhj) {
            ...
            if (this.zzos.zzbP()) {
                if (com_google_android_gms_internal_zzhj2.zzAR != null) {
                    ...
                    if (com_google_android_gms_internal_zzhj2.zzbY()) {
                        ...
                        com_google_android_gms_internal_zzhj2.zzAR.zzgS().zza(new C06841(this, com_google_android_gms_internal_zzhj2));
                    }
                }
