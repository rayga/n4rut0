...
public final class zzc {
    ...
    static class C06811 implements zzb {
        final /* synthetic */ Context zzrn;

        C06811(Context context) {
            this.zzrn = context;
        }
    ...
    public static zzhq zza(Context context, AdRequestInfoParcel adRequestInfoParcel, zza com_google_android_gms_ads_internal_request_zzc_zza) {
        return zza(context, adRequestInfoParcel, com_google_android_gms_ads_internal_request_zzc_zza, new C06811(context));
    }
