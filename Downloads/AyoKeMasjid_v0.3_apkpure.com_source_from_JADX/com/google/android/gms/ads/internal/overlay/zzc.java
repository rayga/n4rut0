...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C02031 implements Runnable {
        ...
        C02031(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C02042 implements Runnable {
        ...
        C02042(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02053 implements Runnable {
        ...
        C02053(zzc com_google_android_gms_ads_internal_overlay_zzc, String str, String str2) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
            this.zzAs = str;
            this.zzAt = str2;
        }
    ...
    class C02064 implements Runnable {
        ...
        C02064(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02075 implements Runnable {
        final /* synthetic */ zzc zzAr;

        C02075(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02086 implements Runnable {
        final /* synthetic */ zzc zzAr;

        C02086(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02097 implements Runnable {
        ...
        C02097(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzAr = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    public zzc(Context context, zzp com_google_android_gms_ads_internal_overlay_zzp) {
        ...
        this.zzAd = 0;
        this.zzAe = 0;
        this.zzAm = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
    ...
    private void zzel() {
        Throwable e;
        zzb.m14v("AdVideoView init MediaPlayer");
    ...
    private void zzem() {
        if (zzep() && this.zzAf.getCurrentPosition() > 0 && this.zzAe != 3) {
            zzb.m14v("AdVideoView nudging MediaPlayer");
            zzb(0.0f);
            this.zzAf.start();
    ...
    private void zzeo() {
        zzb.m14v("AdVideoView abandon audio focus");
        AudioManager zzev = zzev();
        if (zzev != null && this.zzAo) {
    ...
    private void zzes() {
        zzb.m14v("AdVideoView audio focus gained");
        this.zzAo = true;
        zzeu();
    }

    private void zzet() {
        zzb.m14v("AdVideoView audio focus lost");
        this.zzAo = false;
        zzeu();
    }
    ...
    public void onCompletion(MediaPlayer mp) {
        zzb.m14v("AdVideoView completion");
        zzt(5);
        zzu(5);
        zzhu.zzHK.post(new C02042(this));
    }
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        zzt(-1);
        zzu(-1);
        zzhu.zzHK.post(new C02053(this, str, str2));
        return true;
    }

    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        String str = (String) zzAb.get(Integer.valueOf(extra));
        zzb.m14v("AdVideoView MediaPlayer info: " + ((String) zzAb.get(Integer.valueOf(what))) + ":" + str);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzb.m14v("AdVideoView prepared");
        zzt(2);
        this.zzAc.zzeL();
        zzhu.zzHK.post(new C02031(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        zzb.m14v("AdVideoView surface created");
        zzel();
        zzhu.zzHK.post(new C02064(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        zzb.m14v("AdVideoView surface destroyed");
        if (this.zzAf != null && this.zzAp == 0) {
            this.zzAp = this.zzAf.getCurrentPosition();
        }
        zzhu.zzHK.post(new C02075(this));
        zzt(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int w, int h) {
        Object obj = 1;
        zzb.m14v("AdVideoView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        zzb.m14v("AdVideoView size changed: " + width + " x " + height);
    ...
    public void pause() {
        zzb.m14v("AdVideoView pause");
        if (zzep() && this.zzAf.isPlaying()) {
            this.zzAf.pause();
            zzt(4);
            zzhu.zzHK.post(new C02097(this));
        }
        zzu(4);
    }

    public void play() {
        zzb.m14v("AdVideoView play");
        if (zzep()) {
            this.zzAf.start();
            zzt(3);
            zzhu.zzHK.post(new C02086(this));
        }
        zzu(3);
    }

    public void seekTo(int millis) {
        zzb.m14v("AdVideoView seek " + millis);
        if (zzep()) {
