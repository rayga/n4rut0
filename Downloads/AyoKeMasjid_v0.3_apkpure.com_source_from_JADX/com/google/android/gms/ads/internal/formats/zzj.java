...
public class zzj extends zza implements OnClickListener, OnTouchListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C02021 implements Runnable {
        ...
        C02021(zzj com_google_android_gms_ads_internal_formats_zzj, zzh com_google_android_gms_ads_internal_formats_zzh) {
    ...
    public void zzb(zzd com_google_android_gms_dynamic_zzd) {
        synchronized (this.zzpc) {
            ...
            zzhu.zzHK.post(new C02021(this, com_google_android_gms_ads_internal_formats_zzh));
