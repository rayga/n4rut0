...
public final class zzj {
    ...
    public zzj(Context context, AttributeSet attributeSet) {
        Object obj = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0197R.styleable.AdsAttrs);
        Object string = obtainAttributes.getString(C0197R.styleable.AdsAttrs_adSize);
        Object string2 = obtainAttributes.getString(C0197R.styleable.AdsAttrs_adSizes);
        ...
        this.zzoZ = obtainAttributes.getString(C0197R.styleable.AdsAttrs_adUnitId);
