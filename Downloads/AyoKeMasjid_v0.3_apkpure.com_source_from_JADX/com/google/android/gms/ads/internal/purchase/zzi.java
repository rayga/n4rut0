...
public class zzi {
    ...
    class C02111 implements ServiceConnection {
        final /* synthetic */ zzi zzCn;
        final /* synthetic */ Context zzrn;

        C02111(zzi com_google_android_gms_ads_internal_purchase_zzi, Context context) {
    ...
    public void zzy(Context context) {
        ServiceConnection c02111 = new C02111(this, context);
        Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
        intent.setPackage(GooglePlayServicesUtil.GOOGLE_PLAY_STORE_PACKAGE);
        context.bindService(intent, c02111, 1);
    }
}
