...
public abstract class zzc extends zzb implements zzg, zzfc {
    ...
    class C02181 implements Runnable {
        ...
        C02181(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhj_zza) {
    ...
    class C02212 implements Runnable {
        ...
        class C02191 implements OnTouchListener {
            final /* synthetic */ zze zzoD;
            final /* synthetic */ C02212 zzoE;

            C02191(C02212 c02212, zze com_google_android_gms_ads_internal_zze) {
                this.zzoE = c02212;
        ...
        class C02202 implements OnClickListener {
            ...
            C02202(C02212 c02212, zze com_google_android_gms_ads_internal_zze) {
                this.zzoE = c02212;
                this.zzoD = com_google_android_gms_ads_internal_zze;
            }
        ...
        C02212(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhj_zza, zzcd com_google_android_gms_internal_zzcd) {
            this.zzoB = com_google_android_gms_ads_internal_zzc;
            this.zzoA = com_google_android_gms_internal_zzhj_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C02191(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C02202(this, com_google_android_gms_ads_internal_zze));
    ...
    protected void zza(zza com_google_android_gms_internal_zzhj_zza, zzcd com_google_android_gms_internal_zzcd) {
        if (com_google_android_gms_internal_zzhj_zza.errorCode != -2) {
            zzhu.zzHK.post(new C02181(this, com_google_android_gms_internal_zzhj_zza));
            return;
        }
        ...
        zzhu.zzHK.post(new C02212(this, com_google_android_gms_internal_zzhj_zza, com_google_android_gms_internal_zzcd));
    }
