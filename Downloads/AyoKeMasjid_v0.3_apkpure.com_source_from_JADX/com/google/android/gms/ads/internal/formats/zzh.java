...
public class zzh {
    ...
    class C06751 implements zzdg {
        final /* synthetic */ zzh zzwk;

        /* renamed from: com.google.android.gms.ads.internal.formats.zzh.1.1 */
        class C06741 implements com.google.android.gms.internal.zziq.zza {
            final /* synthetic */ Map zzwl;
            final /* synthetic */ C06751 zzwm;

            C06741(C06751 c06751, Map map) {
                this.zzwm = c06751;
                this.zzwl = map;
            }
        ...
        C06751(zzh com_google_android_gms_ads_internal_formats_zzh) {
        ...
        public void zza(zzip com_google_android_gms_internal_zzip, Map<String, String> map) {
            this.zzwk.zzoL.zzgS().zza(new C06741(this, map));
            this.zzwk.zzoL.loadData((String) map.get("overlayHtml"), "text/html", Key.STRING_CHARSET_NAME);
        }
    }

    /* renamed from: com.google.android.gms.ads.internal.formats.zzh.2 */
    class C06762 implements zzdg {
        final /* synthetic */ zzh zzwk;

        C06762(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwk = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C06773 implements zzdg {
        final /* synthetic */ zzh zzwk;

        C06773(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwk = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C06784 implements zzdg {
        final /* synthetic */ zzh zzwk;

        C06784(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwk = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C06795 implements zzdg {
        final /* synthetic */ zzh zzwk;

        C06795(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwk = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    public zzip zzdy() {
        ...
        this.zzwf.zza("/loadHtml", new C06751(this));
        this.zzwf.zza("/showOverlay", new C06762(this));
        this.zzwf.zza("/hideOverlay", new C06773(this));
        this.zzoL.zzgS().zza("/hideOverlay", new C06784(this));
        this.zzoL.zzgS().zza("/sendMessageToSdk", new C06795(this));
        return this.zzoL;
    }
