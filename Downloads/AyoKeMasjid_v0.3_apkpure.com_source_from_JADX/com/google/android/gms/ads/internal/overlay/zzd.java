...
public class zzd extends com.google.android.gms.internal.zzfe.zza implements zzo {
    ...
    class C06801 implements com.google.android.gms.internal.zziq.zza {
        final /* synthetic */ zzd zzAL;

        C06801(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    protected void zzv(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzoL.zzgS().zza(new C06801(this));
            if (this.zzAx.url != null) {
                this.zzoL.loadUrl(this.zzAx.url);
            } else if (this.zzAx.zzAV != null) {
                this.zzoL.loadDataWithBaseURL(this.zzAx.zzAT, this.zzAx.zzAV, "text/html", Key.STRING_CHARSET_NAME, null);
            } else {
