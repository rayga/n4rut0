...
public abstract class GcmListenerService extends Service {
    ...
    class C03061 implements Runnable {
        ...
        final /* synthetic */ GcmListenerService zzazF;

        C03061(GcmListenerService gcmListenerService, Intent intent) {
            this.zzazF = gcmListenerService;
            this.val$intent = intent;
        }

        public void run() {
            this.zzazF.zzk(this.val$intent);
        }
    }

    /* renamed from: com.google.android.gms.gcm.GcmListenerService.2 */
    class C03072 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzazF;

        C03072(GcmListenerService gcmListenerService, Intent intent) {
            this.zzazF = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    L_0x003e:
        r1 = r4.zzpc;	 Catch:{ all -> 0x0085 }
        monitor-enter(r1);	 Catch:{ all -> 0x0085 }
        r0 = r4.zzazE;	 Catch:{ all -> 0x00a8 }
        r0 = r0 + -1;
        r4.zzazE = r0;	 Catch:{ all -> 0x00a8 }
        r0 = r4.zzazE;	 Catch:{ all -> 0x00a8 }
        if (r0 != 0) goto L_0x0050;
    L_0x004b:
        r0 = r4.zzazD;	 Catch:{ all -> 0x00a8 }
    ...
    public final int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C03061(this, intent));
        } else {
            new C03072(this, intent).execute(new Void[0]);
        }
        return 3;
    }
