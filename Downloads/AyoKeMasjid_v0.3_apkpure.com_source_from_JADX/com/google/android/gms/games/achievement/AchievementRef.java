...
public final class AchievementRef extends zzc implements Achievement {
    ...
    public Uri getRevealedImageUri() {
        return zzce("revealed_icon_image_uri");
    }
    ...
    public Uri getUnlockedImageUri() {
        return zzce("unlocked_icon_image_uri");
    }
    ...
    public long getXpValue() {
        return (!zzcd("instance_xp_value") || zzcf("instance_xp_value")) ? getLong("definition_xp_value") : getLong("instance_xp_value");
    }
