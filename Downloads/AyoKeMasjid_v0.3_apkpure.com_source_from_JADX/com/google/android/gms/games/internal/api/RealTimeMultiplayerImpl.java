...
public final class RealTimeMultiplayerImpl implements RealTimeMultiplayer {
    private static <L> zzl<L> zza(GoogleApiClient googleApiClient, L l) {
    ...
    public void create(GoogleApiClient apiClient, RoomConfig config) {
        ...
        if (zzb != null) {
            zzb.zza(apiClient.zzp(config.getRoomUpdateListener()), zza(apiClient, config.getRoomStatusUpdateListener()), zza(apiClient, config.getMessageReceivedListener()), config);
        }
    }
    ...
    public void join(GoogleApiClient apiClient, RoomConfig config) {
        GamesClientImpl zzb = Games.zzb(apiClient, false);
        if (zzb != null) {
            zzb.zzb(apiClient.zzp(config.getRoomUpdateListener()), zza(apiClient, config.getRoomStatusUpdateListener()), zza(apiClient, config.getMessageReceivedListener()), config);
        }
    }
    ...
    public void leave(GoogleApiClient apiClient, RoomUpdateListener listener, String roomId) {
        GamesClientImpl zzb = Games.zzb(apiClient, false);
        if (zzb != null) {
            zzb.zza(apiClient.zzp(listener), roomId);
        }
    }
