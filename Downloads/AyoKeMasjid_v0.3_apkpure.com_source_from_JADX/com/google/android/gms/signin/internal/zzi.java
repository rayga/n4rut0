...
public class zzi extends zzj<zzf> implements zzd {
    ...
    private static class zza extends com.google.android.gms.signin.internal.zzd.zza {
        ...
        class C04331 implements Runnable {
            ...
            final /* synthetic */ zza zzaOs;

            C04331(zza com_google_android_gms_signin_internal_zzi_zza, List list, String str, zzf com_google_android_gms_signin_internal_zzf) {
            ...
            public void run() {
                try {
                    CheckResult onCheckServerAuthorization = this.zzaOs.zzzq().onCheckServerAuthorization(this.zzaOq, Collections.unmodifiableSet(new HashSet(this.zzaOp)));
        ...
        class C04342 implements Runnable {
            ...
            C04342(zza com_google_android_gms_signin_internal_zzi_zza, String str, String str2, zzf com_google_android_gms_signin_internal_zzf) {
                this.zzaOs = com_google_android_gms_signin_internal_zzi_zza;
                this.zzaOq = str;
                this.zzaOt = str2;
                this.zzaOr = com_google_android_gms_signin_internal_zzf;
        ...
        private ServerAuthCodeCallbacks zzzq() throws RemoteException {
        ...
        public void zza(String str, String str2, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaOo.submit(new C04342(this, str, str2, com_google_android_gms_signin_internal_zzf));
        }

        public void zza(String str, List<Scope> list, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaOo.submit(new C04331(this, list, str, com_google_android_gms_signin_internal_zzf));
        }
    }
