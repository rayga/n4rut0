...
public class zzdg extends zzdd {
    ...
    static {
        ...
        zzaTf = Arrays.asList(new String[]{ProductAction.ACTION_DETAIL, ProductAction.ACTION_CHECKOUT, ProductAction.ACTION_CHECKOUT_OPTION, Promotion.ACTION_CLICK, ProductAction.ACTION_ADD, ProductAction.ACTION_REMOVE, ProductAction.ACTION_PURCHASE, ProductAction.ACTION_REFUND});
    ...
    zzdg(Context context, DataLayer dataLayer, zzdc com_google_android_gms_tagmanager_zzdc) {
        ...
        this.zzaTk.add(BuildConfig.FLAVOR);
        this.zzaTk.add("0");
    ...
    private void zza(Tracker tracker, Map<String, zza> map) {
        ...
        if (zzfd == null) {
            zzbg.m16e("Cannot find transactionId in data layer.");
            return;
        }
            ...
            if (zzfe != null) {
                for (Map map2 : zzfe) {
                    if (map2.get("name") == null) {
                        zzbg.m16e("Unable to send transaction item hit due to missing 'name' field.");
                        return;
                    }
            ...
            if (obj instanceof List) {
                for (Map map4 : (List) obj) {
                    try {
                        ...
                        zzbg.m16e("Failed to extract a product from DataLayer. " + e.getMessage());
                    }
                }
            }
            ...
            if (r0 != null) {
                for (Map map42 : r0) {
                    try {
                        ...
                        zzbg.m16e("Failed to extract a promotion from DataLayer. " + e2.getMessage());
                    }
                }
                                ...
                                if (list != null) {
                                    for (Map map22 : list) {
                                        try {
                                            ...
                                            zzbg.m16e("Failed to extract a product from DataLayer. " + e3.getMessage());
                                        }
                                    }
                                }
                                try {
                                    ...
                                    zzbg.m16e("Failed to extract a product action from DataLayer. " + e22.getMessage());
                                }
                            }
                        }
                    }
