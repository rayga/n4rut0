...
class zzj extends zzdd {
    ...
    class C08391 implements zza {
        final /* synthetic */ Context zzrn;

        C08391(Context context) {
            this.zzrn = context;
        }
    ...
    public zzj(Context context) {
        this(context, new C08391(context));
    }
                ...
                if (zzl instanceof List) {
                    for (Object zzl2 : (List) zzl2) {
                        if (zzl2 instanceof Map) {
                            ...
                            zzbg.m16e("ArbitraryPixel: additional params contains non-map: not sending partial hit: " + buildUpon.build().toString());
                            return;
                        }
                    }
                }
                zzbg.m16e("ArbitraryPixel: additional params not a list: not sending partial hit: " + buildUpon.build().toString());
                return;
            }
            String uri = buildUpon.build().toString();
            this.zzaOP.zzzy().zzeH(uri);
            zzbg.m17v("ArbitraryPixel: url = " + uri);
            if (zzg != null) {
