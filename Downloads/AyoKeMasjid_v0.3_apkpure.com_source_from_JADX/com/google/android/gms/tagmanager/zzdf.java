...
public class zzdf {
    ...
    private static double getDouble(Object o) {
        ...
        zzbg.m16e("getDouble received non-Number");
        return 0.0d;
    }
    ...
    public static zza zzK(Object obj) {
        ...
        if (obj instanceof String) {
            ...
            zzbg.m16e("Converting to Value from unknown object type: " + (obj == null ? "null" : obj.getClass().toString()));
            return zzaSV;
        }
    ...
    private static long zzN(Object obj) {
        ...
        zzbg.m16e("getInt64 received non-Number");
        return 0;
    }
    ...
    private static zzde zzeZ(String str) {
        try {
            ...
            zzbg.m16e("Failed to convert '" + str + "' to a number.");
            return zzaSQ;
        }
    }
        ...
        switch (com_google_android_gms_internal_zzag_zza.type) {
            ...
            case CompletionEvent.STATUS_CANCELED /*3*/:
                if (com_google_android_gms_internal_zzag_zza.zziW.length != com_google_android_gms_internal_zzag_zza.zziX.length) {
                    zzbg.m16e("Converting an invalid value to object: " + com_google_android_gms_internal_zzag_zza.toString());
                    return zzaSN;
                }
            ...
            case Barcode.PHONE /*4*/:
                zzbg.m16e("Trying to convert a macro reference to object");
                return zzaSN;
            case Barcode.PRODUCT /*5*/:
                zzbg.m16e("Trying to convert a function id to object");
                return zzaSN;
            case Barcode.SMS /*6*/:
            ...
            default:
                zzbg.m16e("Failed to convert a value of type: " + com_google_android_gms_internal_zzag_zza.type);
                return zzaSN;
        }
    }
}
