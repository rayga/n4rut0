...
class zzat extends Thread implements zzas {
    ...
    class C04411 implements Runnable {
        ...
        C04411(zzat com_google_android_gms_tagmanager_zzat, zzas com_google_android_gms_tagmanager_zzas, long j, String str) {
    ...
    public void run() {
        while (!this.mClosed) {
            try {
                ...
                zzbg.m16e("Error on Google TagManager Thread: " + zzd(th));
                zzbg.m16e("Google TagManager is shutting down.");
                this.zzMT = true;
            }
        }
    }
    ...
    void zzh(String str, long j) {
        zzg(new C04411(this, this, j, str));
    }
}
