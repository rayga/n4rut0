...
class zzba<K, V> implements zzl<K, V> {
    ...
    class C04431 extends LruCache<K, V> {
        final /* synthetic */ zzba zzaQA;
        final /* synthetic */ zza zzaQz;

        C04431(zzba com_google_android_gms_tagmanager_zzba, int i, zza com_google_android_gms_tagmanager_zzm_zza) {
    ...
    zzba(int i, zza<K, V> com_google_android_gms_tagmanager_zzm_zza_K__V) {
        this.zzaQy = new C04431(this, i, com_google_android_gms_tagmanager_zzm_zza_K__V);
    }
