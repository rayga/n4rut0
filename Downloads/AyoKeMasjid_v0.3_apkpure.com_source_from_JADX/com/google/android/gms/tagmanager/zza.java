...
public class zza {
    ...
    class C04402 implements Runnable {
        ...
        C04402(zza com_google_android_gms_tagmanager_zza) {
    ...
    class C08311 implements zza {
        final /* synthetic */ zza zzaOH;

        C08311(zza com_google_android_gms_tagmanager_zza) {
            this.zzaOH = com_google_android_gms_tagmanager_zza;
        }
    ...
    public zza(Context context, zza com_google_android_gms_tagmanager_zza_zza, zzlm com_google_android_gms_internal_zzlm) {
        ...
        this.zzHt = new Thread(new C04402(this));
    }
