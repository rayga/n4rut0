...
public final class GoogleAuthUtil {
    ...
    static {
        ...
        zzQI = new ComponentName(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE, "com.google.android.gms.auth.GetToken");
        zzQJ = new ComponentName(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE, "com.google.android.gms.recovery.RecoveryService");
    }
    ...
    public static void clearToken(Context context, String token) throws GooglePlayServicesAvailabilityException, GoogleAuthException, IOException {
        ...
        if (zzak.zza(zzQI, com_google_android_gms_common_zza, "GoogleAuthUtil")) {
            try {
                Bundle zza = zzau.zza.zza(com_google_android_gms_common_zza.zzmS()).zza(token, bundle);
    ...
    public static List<AccountChangeEvent> getAccountChangeEvents(Context ctx, int eventIndex, String accountName) throws GoogleAuthException, IOException {
        ...
        if (zzak.zza(zzQI, com_google_android_gms_common_zza, "GoogleAuthUtil")) {
            try {
                List<AccountChangeEvent> events = zzau.zza.zza(com_google_android_gms_common_zza.zzmS()).zza(new AccountChangeEventsRequest().setAccountName(accountName).setEventIndex(eventIndex)).getEvents();
                zzak.zzb(zzQI, com_google_android_gms_common_zza, "GoogleAuthUtil");
                return events;
            } catch (Throwable e) {
                Log.i("GoogleAuthUtil", "GMS remote exception ", e);
    ...
    public static Bundle zza(Context context, Account account, String str, Bundle bundle) throws IOException, UserRecoverableAuthException, GoogleAuthException {
        ...
        if (zzak.zza(zzQI, com_google_android_gms_common_zza, "GoogleAuthUtil")) {
            try {
                bundle2 = zzau.zza.zza(com_google_android_gms_common_zza.zzmS()).zza(account, str, bundle2);
                if (bundle2 == null) {
